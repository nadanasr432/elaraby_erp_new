            ...
            <div class="banner-content">
               ...
               <form class="mt-4" action="{{ route('company.admin.login.store') }}" method="POST"
                   ...
                   <!-- Terms and Conditions Checkbox -->
                    <div class="col-lg-12 col-xs-12 pull-right text-right">
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input 
                                    ...
                                    required
                                    checked
                                    oninvalid="this.setCustomValidity('الموافقه علي الشروط والاحكام - سياسة الخصوصية')" 
                                    oninput="this.setCustomValidity('')"
                                >
                                <label class="custom-control-label text-white" for="terms_conditions">
                                    <a href="{{ route('terms_conditions') }}" target="_blank" class="text-warning">
                                        {{ __('main.accept_terms') }}
                                    </a>
                                    -
                                    <a href="{{ route('privacy') }}" target="_blank" class="text-warning">
                                        {{ __('main.privacy') }}
                                    </a>
                                </label>
                            </div>
