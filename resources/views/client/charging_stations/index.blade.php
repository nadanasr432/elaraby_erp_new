                ...
                <div class="card-header pb-0">
                    <div class="col-lg-12 margin-tb d-flex flex-wrap align-items-center justify-content-between">
                        <h5 class=" alert custom-title">
                            {{ __('sidebar.list-of-charging_stations') }}</h5>
                        <a class="btn btnn text-white px-3 py-1" style="background-color:#36c7d6""
                            href="{{ route('charging-stations.create') }}">
                            ...
                            <tbody>
                                ...
                                @foreach ($stations as $key => $station)
                                    <tr>
                                        ...
                                        <td>{{ $station->city }}</td>
                                        <td>
                                            <a href="{{ route('charging-stations.edit', $station->id) }}" class=" "
...
<script>
    $(document).ready(function() {
        $('.delete_station').click(function() {
            ...
            let actionUrl = "{{ route('charging-stations.destroy', ':id') }}".replace(':id',
            stationId);
