                        ...
                        <table
                            ...
                            <tr
                                ...
                                <td dir="rtl">
                                    ...
                                    @else
                                        @if ($realtotal > 0)
                                            {{ $sumWithOutTax }} <img src="{{ asset('images/Sr_coin.svg') }}" width="5%">
                                        @endif
                            ...
                            <tr
                                ...
                                @if ($company->tax_value_added && $company->tax_value_added != 0)
                                    <td dir="rtl">{{ $sale_bill->total_tax }} <img src="{{ asset('images/Sr_coin.svg') }}" width="5%"> </td>
                                @else
                            ...
                            <tr
                                ...
                                <td dir="rtl">{{ $sale_bill->paid }} <img src="{{ asset('images/Sr_coin.svg') }}" width="5%"></td>
                            ...
                            <tr
                                ...
                                <td dir="rtl">
                                    {{ $sale_bill->rest }} <img src="{{ asset('images/Sr_coin.svg') }}" width="5%">
                                </td>
                    ...
                    <div class="products-details p-0 col-6"
                        ...
                        <table
                            ...
                            <tr
                                ...
                                {{-- @dd($sale_bill) --}}
                                <td dir="rtl">
                                    {{ $sale_bill->final_total - $sale_bill->paid }} <img src="{{ asset('images/Sr_coin.svg') }}" width="5%">
                                </td>
                                <td style="text-align: right;padding-right: 14px;">
                                    @lang('sales_bills.Residual')
                                </td>
