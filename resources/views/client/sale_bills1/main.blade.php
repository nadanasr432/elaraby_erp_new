    ...
    <div class="invoice-container border mt-4">
        ...
        <div class="all-data" style="border-top: 1px solid #2d2d2d20;padding-top: 25px;">
                            ...
                            @if (!$elements->isEmpty())
                                ...
                                @foreach ($elements as $element)
                                    ...
                                    <tr
                                        ...
                                        <td>
                                            {{ round($element->tax_type == 0 ? $element->quantity_price + $element->tax_value - $elementDiscount : $element->quantity_price - $elementDiscount, 2) }}
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
            ...
            @else
                <div class="products-details mt-2" style=" padding: 0px 16px;">
                    <table class="invoice-information"
                        style="width: 100%;width: 100%;background: {{ $currentColor }}; border-radius: 8px !important; overflow: hidden;box-shadow: rgb(99 99 99 / 20%) 0px 2px 0px 0px;">
                        <thead>
                            <tr
                                style="font-size:18px !important; background: {{ $currentColor }}; color: white; height: 44px !important; text-align: center;">
                                <th>@lang('sales_bills.total')</th>
                ...
                <div class="row px-4 pt-2 d-flex justify-content-between">
                    ...
                    <div class="products-details p-0 col-7"
                        ...
                        <table
                            ...
                            <tr
                                style="background: {{ $currentColor }};border-bottom:1px solid #2d2d2d30;font-weight: bold;font-size:16px !important; height: 37px !important; text-align: center;background: {{ $currentColor }};color:white;">
                                <td style="text-align: left;padding-right: 14px;background: {{ $currentColor }};">
                    ...
                    <div class="products-details p-0 col-7"
                        ...
                        <table
                            ...
                            <tr
                                ...
                                <td
                                    style="text-align: right;padding-right: 14px;"style="background: {{ $currentColor }}">
                            ...
                            <tr
                                style="background: {{ $currentColor }};border-bottom:1px solid #2d2d2d30;font-weight: bold;font-size:18px !important; height: 37px !important; text-align: center;background: {{ $currentColor }};color:white;">
                                {{-- @if ($company->tax_value_added && $company->tax_value_added != 0) --}}
                                {{-- @if ($discount->action_type == 'poundAfterTax') --}}
                                <td dir="rtl">
