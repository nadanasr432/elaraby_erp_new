                    ...
                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        <div class="row px-2">
                            ...
                            <a onclick="history.back()"
                                class="btn  text-white d-flex align-items-center ml-1" style="background-color: #ec6880"
                    ...
                    @if (isset($all_quotations))
                        @if (!$all_quotations->isEmpty())
                            <table style="border-radius: 5px !important; overflow-x: hidden;"
                                class="defaultTableMain table dataTable" id="example-table" role="grid">
                                            ...
                                            <td style="padding: 5px !important;">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu p-0" aria-labelledby="dropdownMenuButton"
                                                        ...
                                                        <a href="{{ route('client.quotations.print', $quotation->quotation_number) }}"
                                                            class="dropdown-item" target="_blank"
                                                            style="font-size: 12px !important; padding: 9px 11px;border-bottom: 1px solid #2d2d2d2d">
                                                            <svg style="width: 15px; fill: forestgreen;display: inline;margin-left: 5px;"
                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                                        ...
                                                        <button bill_id="{{ $quotation->id }}"
                                                            ...
                                                            type="button" id="1"
                                                            class="dropdown-item modal-effect delete_bill d-inline"
