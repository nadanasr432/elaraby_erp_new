...
@section('content')
                ...
                <div class="card-header border-bottom border-secondary p-1">
                    ...
                    <form class="pr-1 pl-1 mb-0 pb-0 mt-2" action="#" method="POST">
                        ...
                        <div class="col-lg-3 pl-0 pull-right no-print">
                            ...
                            <select name="store_id" id="store_id" class="selectpicker w-100" data-style="btn-newdark"
                        ...
                        <div class="col-lg-3 p-0 pull-right no-print">
                            ...
                            <select name="outer_client_id" id="outer_client_id" data-style="btn-newdark"
                                title="{{ __('sales_bills.client-name') }}" class="selectpicker w-100"
                        ...
                        <div class="options no-print">
                            ...
                            <div class="col-lg-4 pr-0 pull-right">
                                ...
                                <input style="width: 40%;" type="number" placeholder="الكمية" name="quantity"
                                    id="quantity" class="form-control d-inline float-left" />
                            ...
                            <div class="col-lg-12 pull-right mt-1 p-0">
                                ...
                                <textarea name="notes" id="notes" dir="rtl" class="form-control" style="min-height:70px;"></textarea>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-xs-6 pull-right">
                            <div class="form-group" dir="rtl">
                                ...
                                <input type="number" value="0" name="discount_value"
                                    style="width: 30%;display: inline;float: right;" disabled id="discount_value"
                                    class="form-control " />
    ...
    <div class="col-lg-12 no-print" style="padding-top: 25px;height: 40px !important;margin-bottom:60px;">
        ...
        <form
            ...
            id='saveANDPRINT' action="{{ route('client.quotations.redirectANDprint') }}" method="POST">
            @csrf
            @method('POST')
    ...
    $.post("{{ url('/client/quotations/post') }}", {
        ...
        if (data.status) {
            ...
            $('#discount_type, #discount_value, #extra_type, #extra_value, #exec_discount, #exec_extra').attr('disabled', false);
            $('.print_btn, .close_btn, .save_btn, .send_btn').attr('disabled', false).removeClass('disabled');
            ...
            appendNewElement(data.new_element);
...
function attachElementHandlers() {
    ...
    $('.edit_element').on('click', function() {
        ...
        $.post('/client/quotations/edit-element', {
            ...
            $('#add').hide();
            $('#edit').show().attr('element_id', element_id).attr('quotation_number', quotation_number);
        });
    });
}
