...
@section('content')
                            ...
                            <li>
                                <a href="{{ route('client.billing.settings.edit') }}">
                                    @if ($company->tax_number == '')
                                        <?php $uncompleted++; ?>
                                        <span class='text-danger'>
                                            <i class='fa fa-close'></i>{{ __('home.register-company-tax-number') }}</span>
                                    @else
                                        <span class='text-success'>
                                            <i class='fa fa-check'></i>{{ __('home.register-company-tax-number') }}</span>
                                    @endif
                                </a>
                            </li>
                            <li>
        ...
        <div class="col-lg-12">
            ...
            @if (empty($package) || $package->debt == '1')
                @if ($all_outer_clients->isEmpty())
                    @can('اضافة عميل جديد')
                        <div class="col-lg-3 pull-right">
                            <a href="{{ route('client.outer_clients.create') }}" class="btn btn-md btn-common btn-block">
                                <i class="fa fa-plus"></i>
    ...
    <div class="dashboard-content mt-2" style="display: none;">
        ...
        <div class="row match-height p-1" style=";">
            ...
            <div class="col-md-4 ">
                <div id="pieContainer" style="border: 1px solid #2d2d2d30; height: 460px;"  class="card"></div>
            </div>
                                    ...
                                    @if ($sale_bills && count($sale_bills) != 0)
                                        @foreach ($sale_bills as $invoice)
                                            <tr>
                                                ...
                                                <td class="text-truncate"
                                                    style="color: #637381 !important; font-size: 18px; font-family: Cairo; font-weight: 600;">
                                                    {{ $invoice->final_total }} {{ $company->currency }}</td>
                                            </tr>
                                        @endforeach
                                    @else
                                        <tr>
    ...
    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-left pr-5 pl-5 mt-5 mb-5"
        ...
        <li class="dropdown-menu-header">
            <h4 class="dropdown-header m-0">
                <span class="grey darken-2" style="font-size: 16px !important;">@lang('home.Quick shortcuts') </span>
