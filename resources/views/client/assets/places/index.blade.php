...
@section('content')
                    ...
                    <div class="card-header pb-0 control-column">
                        <div id="example1_wrapper" class="col-lg-12 dataTables_wrapper dt-bootstrap4 no-footer">
                            <div class="dt-buttons btn-group">
                                <button class="btn btn-secondary buttons-excel buttons-html5" tabindex="0"
                                    ...
                                    <a href="{{ route('places.export.excel') }}"
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input column-checkbox" id="column1"
                                                data-column="1" data-table="places-table" checked>
                                            <label class="form-check-label"
                                                for="column1">{{ __('places.code') }}</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input column-checkbox" id="column2"
                                                data-column="2" data-table="places-table" checked>
                                            <label class="form-check-label"
                                                for="column2">{{ __('places.places-description-ar') }}</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input column-checkbox" id="column3"
                                                data-column="3" data-table="places-table" checked>
                                            <label class="form-check-label"
                                                for="column3">{{ __('places.places-description-en') }}</label>
                                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="col-lg-12 margin-tb">
                                <a class="btn pull-left btn-primary btn-sm custom-button-size" href="{{ route('places.create') }}"><i
                                        class="fa fa-plus"></i> {{ __('sidebar.add-new-file_places') }} </a>
                            ...
                            <table class="table table-condensed table-striped table-bordered text-center table-hover"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">{{ __('places.code') }}</th>
                                        <th class="text-center">{{ __('places.places-description-ar') }}</th>
                                        <th class="text-center">{{ __('places.places-description-en') }}</th>
                                    ...
                                    @foreach ($places as $place)
                                        <tr>
                                            ...
                                            <td class="control-column">
                                                ...
                                                <a class="modal-effect btn btn-sm btn-danger delete_places"
                                                    places_id="{{ $place->id }}"
                                                    places_name="{{ $place->name }}" data-toggle="modal"
                    ...
                    <div class="modal-content modal-content-demo">
                        ...
                        <form action="{{ route('places.destroy', 'test') }}" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <input class="form-control" name="placesname" id="placesname" type="text"
                                    readonly>
                            </div>
    ...
    <script>
        ...
        function printTable() {
            ...
            var table = document.getElementById('places-table').cloneNode(true);
