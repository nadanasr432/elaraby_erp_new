                    ...
                    <div class="card-header pb-0 control-column">
                        <div id="example1_wrapper" class="col-lg-12 dataTables_wrapper dt-bootstrap4 no-footer">
                            <div class="dt-buttons btn-group">
                                <button class="btn btn-secondary buttons-excel buttons-html5" tabindex="0"
                                    ...
                                    <a href="{{ route('category.export.excel') }}"
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="col-lg-12 margin-tb">
                                <a class="btn pull-left btn-primary btn-sm custom-button-size" href="{{ route('category.create') }}"><i
                                        class="fa fa-plus"></i> {{ __('sidebar.add-new-file_category') }} </a>
                            ...
                            <table class="table table-condensed table-striped table-bordered text-center table-hover"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">{{ __('categories.category-description-ar') }}</th>
                                        <th class="text-center">{{ __('categories.category-description-en') }}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="control-column">
                                                ...
                                                <a class="modal-effect btn btn-sm btn-danger delete_category"
                                                    ...
                                                    category_name="{{ $category->name }}" data-toggle="modal"
