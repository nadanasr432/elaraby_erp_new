...
<body>
    ...
    <div class="app-content content">
        <nav class="navbar navbar-expand-lg navbar-light " style="height: 59px;background: #0A246A ;">
                ...
                <ul class="navbar-nav" style="height: 52px;align-items: flex-start;" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="d-flex navbar-brand text-white text-center mt-1 pb-2" target="_blank"
                            ...
                            <svg width="19" style="position: relative; top: -3px; margin-left: 6px;"
                                viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <div>
                ...
                <button id="dark-btn" class="bg-transparent border-0 d-none text-white">
