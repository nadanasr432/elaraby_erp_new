                                    ...
                                    @can('قائمة المنتجات التى نفذت')
                                        <li class="{{ Request::is('*/client.products.expires') ? 'active' : '' }}">
                                            <a href="{{ route('client.products.expires') }}">
                                                ...
                                                {{ __('sidebar.products-are-expired') }}
                        ...
                        <ul class="menu-content">
                            <li class="nav-item {{ Request::is('*/sale_bills*') ? 'active open' : '' }}">
                                ...
                                <li class="{{ Request::is('*/sale-bills-new') ? 'active' : '' }}">
                                    <a href="{{ route('client.sale_bills.create1') }}">
                                        <i class="fa fa-plus text-success tx-20"></i>

                                        <span class="menu-title">
                                            {{ __('home.New bill of sale') }}
                                        </span>
                                    </a>
                                </li>
                            @endcan
                            ...
                            @endcan
                            <li class="{{ Request::is('*/pos-returns-list') ? 'active' : '' }}">
                                <a href="{{ url('/client/pos-returns-list') }}">
                                    ...
                                    <span class="menu-title">
                                        {{ __('sidebar.returns-pos-invoices') }}
                                    </span>
                                </a>
                            </li>
                    </li>
                ...
                <li class="nav-item {{ Request::is('*/banks*', '*/safes*') ? 'active open' : '' }}">
                    ...
                    <ul class="menu-content">
                        <li class="nav-item {{ Request::is('*/safes*') ? 'active open' : '' }}">
                            ...
                            <ul
                                class="menu-content    'Not Returned' => 'غير مرتجع',
...
">
            ...
            <ul class="menu-content">
                ...
                {{-- <li class="{{ Request::is('groupes*') ? 'active' : '' }}">
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="{{ Request::is('groupes/create') ? 'active' : '' }}">
                ...
                {{-- <li class="{{ Request::is('*/assets/category') ? 'active' : '' }}">
                    <a href="#">
                        ...
                        {{ __('main.categories_assets') }}
                    </a>
                    <ul class="menu-content">
                        <li class="{{ Request::is('*/assets/category/index') ? 'active' : '' }}">
                            <a href="{{ route('category.index') }}">
                                {{ __('main.index') }}
                            </a>
                        </li>
                        <li class="{{ Request::is('*/assets/category/create') ? 'active' : '' }}">
                ...
                <li class="{{ Request::is('*/countries') ? 'active' : '' }}">
                    ...
                    <ul class="menu-content">
                        <li class="{{ Request::is('*/countries/index') ? 'active' : '' }}">
                            <a href="{{ route('countries.index') }}">
                                {{ __('main.index') }}
                            </a>
                        </li>
                        <li class="{{ Request::is('*/countries/create') ? 'active' : '' }}">
        ...
        <li class="{{ Request::is('*/places') ? 'active' : '' }}">
            <a href="#">
                ...
                {{ __('main.building_roles') }}
            </a>
            <ul class="menu-content">
                <li class="{{ Request::is('*/building_roles/index') ? 'active' : '' }}">
                    <a href="{{ route('building_roles.index') }}">
                        {{ __('main.index') }}
                    </a>
                </li>
                <li class="{{ Request::is('*/building_roles/create') ? 'active' : '' }}">
                    <a href="{{ route('building_roles.create') }}">
                        {{ __('main.create') }}
                    </a>
                </li>
            </ul>
        ...
        <li class="{{ Request::is('*/places') ? 'active' : '' }}">
            ...
            <ul class="menu-content">
                <li class="{{ Request::is('*/places/index') ? 'active' : '' }}">
                    <a href="{{ route('places.index') }}">
                        {{ __('main.index') }}
                    </a>
                </li>
                <li class="{{ Request::is('*/places/create') ? 'active' : '' }}">
          ...
          <li class="{{ Request::is('*/rooms') ? 'active' : '' }}">
            ...
            <ul class="menu-content">
                <li class="{{ Request::is('*/rooms/index') ? 'active' : '' }}">
    ...
    ">(تحت الانشاء)</small> --}}
        ...
        <li class="nav-item {{ Request::is('*/Transport Policy*', '*/transport_policy*') ? 'active open' : '' }}">
            <a href="javascript:;">
                <i class="la la-truck"></i>
                <span class="menu-title">
                    {{ __('sidebar.transport_policy') }}
                </span>
            </a>
            <ul class="menu-content">
                <li class="nav-item {{ Request::is('*/transport-policies*') ? 'active open' : '' }}">
                    <a href="{{ route('transport-policies.index') }}">
                        <svg style="width: 15px;fill:#36c7d6;" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
                            <path
                                d="M160 256C160 202.1 202.1 160 256 160C309 160 352 202.1 352 256C352 309 309 352 256 352C202.1 352 160 309 160 256zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z" />
                        ...
                        <span class="menu-title">
                            {{ __('sidebar.transport-policies') }}
                        </span>
                    </a>
                </li>
                <li class="nav-item {{ Request::is('*/charging-stations*') ? 'active open' : '' }}">
                    <a href="{{ route('charging-stations.index') }}">
                        ...
                        <span class="menu-title">
                            {{ __('sidebar.charging_stations') }}
                        </span>
                    </a>
                </li>
                <li class="nav-item {{ Request::is('*/discharging-stations*') ? 'active open' : '' }}">
                    <a href="{{ route('discharging-stations.index') }}">
                        <svg style="width: 15px;fill:#36c7d6;" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
                            <path
                                d="M160 256C160 202.1 202.1 160 256 160C309 160 352 202.1 352 256C352 309 309 352 256 352C202.1 352 160 309 160 256zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z" />
                        ...
                        <span class="menu-title">
                            {{ __('sidebar.discharging_stations') }}
                        </span>
                    </a>
                </li>

                <li class="nav-item {{ Request::is('*/drivers*') ? 'active open' : '' }}">
                ...
                <li class="nav-item {{ Request::is('*/shipments*') ? 'active open' : '' }}">
                    <a href="{{ route('shipments.index') }}">
                        ...
                        <span class="menu-title">
                            {{ __('sidebar.shipments') }}
                        </span>
                    </a>
                </li>
                <li class="nav-item {{ Request::is('*/vehicle-owners*') ? 'active open' : '' }}">
                    <a href="{{ route('vehicle-owners.index') }}">
                        <svg style="width: 15px;fill:#36c7d6;" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
                            <path
                                d="M160 256C160 202.1 202.1 160 256 160C309 160 352 202.1 352 256C352 309 309 352 256 352C202.1 352 160 309 160 256zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z" />
                        ...
                        <span class="menu-title">
                            {{ __('sidebar.vehicle-owners') }}
                        </span>
                    </a>
                </li>
                <li class="nav-item {{ Request::is('*/vehicles*') ? 'active open' : '' }}">
