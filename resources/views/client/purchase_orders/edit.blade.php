...
@section('content')
    ...
    <form target="_blank" action="#" method="POST">
        ...
        <div class="col-lg-3 pull-right no-print">
            ...
            <select name="supplier_id" id="supplier_id" class="selectpicker" data-style="btn-success"
                ...
                @foreach ($suppliers as $supplier)
                    <option @if ($purchase_order->supplier_id == $supplier->id) selected @endif value="{{ $supplier->id }}">
        ...
        <div class="supplier_details no-print">
            <div class="col-lg-4 pull-right">
                ...
                <input type="text" value="{{ $purchase_order->supplier->supplier_category }}" class="form-control"
            ...
            if (!$elements->isEmpty()) {
                ...
                foreach ($elements as $element) {
                    ...
                    echo "<td class='no-print'>
                                        <button type='button' purchase_order_number='" .
                        $element->PurchaseOrder->purchase_order_number .
                        "' element_id='" .
                        $element->id .
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 after_totals">
            ...
            $total = array_sum($sum);
            $previous_extra = \App\Models\PurchaseOrderExtra::where('purchase_order_id', $purchase_order->id)->where('action', 'extra')->first();
            ...
            $previous_discount = \App\Models\PurchaseOrderExtra::where('purchase_order_id', $purchase_order->id)->where('action', 'discount')->first();
                ...
                <div class="col-lg-6 col-md-6 col-xs-6 pull-right">
                    <div class="form-group" dir="rtl">
                        ...
                        <select name="discount_type" id="discount_type" class="form-control"
                            ...
                            <option @if ($purchase_order_discount_type == 'pound') selected @endif value="pound">
                                {{ $extra_settings->currency }}</option>
                            <option @if ($purchase_order_discount_type == 'percent') selected @endif value="percent">%</option>
                        </select>
                ...
                <div class="col-lg-6 col-md-6 col-xs-6 pull-right">
                    <div class="form-group" dir="rtl">
                        ...
                        <select name="extra_type" id="extra_type" class="form-control"
                            style="width: 20%;display: inline;float: right;margin-left: 5px">
                            <option @if ($purchase_order_extra_type == 'pound') selected @endif value="pound">
                                {{ $extra_settings->currency }}</option>
                            <option @if ($purchase_order_extra_type == 'percent') selected @endif value="percent">%</option>
                        </select>
    ...
    <div class="col-lg-12 no-print" style="padding-top: 25px;height: 40px !important;">
        ...
        <a href="{{ route('client.purchase_orders.send', $purchase_order->id) }}" role="button"
            class="btn  send_btn btn-md btn-warning pull-right ml-3"><i class="fa fa-check"></i>
