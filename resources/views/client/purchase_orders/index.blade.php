...
@section('content')
        ...
        <form action="{{ route('client.purchase_orders.filter.key') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="d-flex justify-items-center">
                    ...
                    <button type="submit" class="btn btn-md btn-warning" id="by_purchase_order_id"><i
        ...
        <form action="{{ route('client.purchase_orders.filter.supplier') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="d-flex justify-items-center">
                    ...
                    <button type="submit" class="btn btn-md btn-warning" id="by_supplier_id"><i
                            class="fa fa-search"></i></button>
                </div>
            </div>
        </form>
        ...
        <form action="{{ route('client.purchase_orders.filter.code') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="d-flex justify-items-center">
                    ...
                    <button type="submit" class="btn btn-md btn-warning" id="by_code_universal"><i
                            class="fa fa-search"></i></button>
                </div>
            </div>
        </form>
    ...
    <div id="bill_details">
        ...
        @if (isset($supplier_purchase_orders))
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button bill_id="{{ $purchase_order->id }}"
                                        ...
                                        data-toggle="modal" href="#modaldemo9" title="delete" type="button"
                                        class="modal-effect btn btn-sm btn-danger delete_bill d-inline">
                                        <i class="fa fa-trash"></i>
                                        حذف
                                    </button>

                                    <a href="{{ route('client.purchase_orders.edit', $purchase_order->id) }}"
                                        role="button" class="btn btn-sm btn-success d-inline">
                                        <i class="fa fa-trash"></i>
                                        تعديل
                                    </a>
            ...
            @endif
        @endif
        @if (isset($store_purchase_orders))
            @if (!$store_purchase_orders->isEmpty())
                <div class="alert alert-sm alert-success text-center mt-1 mb-2">
                    اوامر الشراء المتاحة لـ
                    {{ $store_k->store_name }}
                </div>
                <table class='table table-condensed table-striped table-bordered'>
                    ...
                    <tbody>
                        <?php $i = 0;
                        $total = 0; ?>
                        @foreach ($store_purchase_orders as $purchase_order)
                            <tr>
                                <td>{{ ++$i }}</td>
                                <td>{{ $purchase_order->purchase_order_number }}</td>
                                <td>{{ $purchase_order->start_date }}</td>
                                ...
                                <td>
                                    ...
                                    <button bill_id="{{ $purchase_order->id }}"
                                        purchase_order_number="{{ $purchase_order->store->store_name }}"
                                        data-toggle="modal" href="#modaldemo9" title="delete" type="button"
                                        class="modal-effect btn btn-sm btn-danger delete_bill d-inline">
                                        <i class="fa fa-trash"></i>
                                        حذف
