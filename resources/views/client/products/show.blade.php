        ...
        <div class="card">
            ...
            <div class="card-header border-bottom border-secondary p-1">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a class="btn  btn-sm p-1 text-white px-3 py-1" style="background-color: #36c7d6" href="{{ route('client.products.index') }}">
                        عودة للخلف
                    </a>
                </div>
            </div>
            ...
            <div class="card-body p-2">
                ...
                <div class="row p-0">
                    <div class="form-group col-lg-4">
                        <label for="start_date">{{ __('products.Start Date') }}</label>
                        <input type="date" class="form-control" id="start_date" name="start_date"
                            value="{{ old('start_date', $product->start_date ?? '') }}" disabled>
                    </div>
                    <div class="form-group col-lg-4">
                        <label for="end_date">{{ __('products.End Date') }}</label>
                    ...
                    <div class="form-group col-lg-4" dir="rtl">
                        ...
                        <input disabled type="text" name="product_name" id="order_name" placeholder="اسم المنتج"
                            value="{{$product->unit ? $product->unit->unit_name : '-'}}" class="form-control" required>
                    </div>
                    <!---------------------->
                    ...
                    <div class="form-group col-lg-4" dir="rtl">
                        ...
                        <input disabled type="number" name="purchasing_price" id='purchasing_price' class="form-control"
                            value="{{$product->purchasing_price}}" placeholder="سعر التكلفة">
                    </div>
                    <!---------------------->
                    ...
                    <div class="form-group col-lg-4" dir="rtl">
                        ...
                        <input disabled type="number" name="sector_price" placeholder="سعر القطاعي" id="sector_price"
                    ...
                    <!-------color------->
                    <div class="form-group  col-lg-4 d-none" dir="rtl">
                    ...
                    @if($product->product_pic)
                        <div class="form-group col-lg-4 pull-right" dir="rtl">
                            ...
                            <img id="pic" src="{{ asset($product->product_pic) }}" style="width: 100px; height:100px;" />
                        </div>
                    @endif
                    <!---------------------->
