            ...
            <div class="card mg-b-20">
                <div class="card-body">
                    ...
                    <form class="parsley-style-1" id="editForm" name="editForm"
                          action="{{ route('discharging-stations.update', $dischargingStation->id) }}" 
                                    ...
                                    <select required name="country" class="form-control selectpicker py-1"
                                        ...
                                        @foreach ($countries as $country)
                                            <option value="{{ $country->country_name }}" 
                                                {{ $dischargingStation->country == $country->country_name ? 'selected' : '' }}>
