                ...
                <div class="card-body">
                    <div class="col-12 d-flex flex-wrap justify-content-between align-items-center">
                        <h5 s class=" alert custom-title">
                            {{ __('sidebar.add-new-discharging_station') }}
                        </h5>
                        <a class="btn btnn text-white px-3 py-1" style="background-color: #36c7d6" href="{{ route('charging-stations.index') }}">
                            {{ __('main.back') }}</a>
                    ...
                    <form class="parsley-style-1" id="selectForm2" name="selectForm2"
                        action="{{ route('discharging-stations.store') }}" enctype="multipart/form-data" method="post">
                        {{ csrf_field() }}
