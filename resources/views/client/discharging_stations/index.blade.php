                ...
                <div class="card-header pb-0">
                    <div class="col-lg-12 margin-tb d-flex flex-wrap align-items-center justify-content-between">
                        <h5 class=" alert custom-title">
                            {{ __('sidebar.list-of-discharging_stations') }}</h5>
                        <a class="btn btnn text-white px-3 py-1" style="background-color:#36c7d6""
                            href="{{ route('discharging-stations.create') }}">
                            <i class="fa fa-plus"></i> {{ __('sidebar.add-new-charging_station') }} </a>
                        ...
                        <table class="table table-striped table-bordered zero-configuration" id="example-table"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0 text-center">{{ __('main.country') }}</th>
                                    <th class="wd-20p border-bottom-0 text-center">{{ __('main.region') }}</th>
                                    <th class="wd-15p border-bottom-0 text-center">{{ __('main.city') }}</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($stations as $key => $station)
                                    <tr>
                                        ...
                                        <td>{{ $station->city }}</td>
                                        <td>
                                            <a href="{{ route('discharging-stations.edit', $station->id) }}" class=" "
                                            ...
                                            <a class="modal-effect delete_station" data-id="{{ $station->id }}"
                                                data-name="{{ $station->country }}" data-toggle="modal" href="#modaldemo9"
            ...
            <div class="modal-dialog modal-dialog-centered" supplier="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header text-center">
                        <h6 class="modal-title w-100" style="font-family: 'Cairo'; ">حذف محطة الشحن</h6>
                    ...
                    <form id="deleteForm" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <input class="form-control" name="station_name" id="station_name" type="text" readonly>
                        </div>
...
<script>
    $(document).ready(function() {
        $('.delete_station').click(function() {
            ...
            let actionUrl = "{{ route('discharging-stations.destroy', ':id') }}".replace(':id',
            stationId);
