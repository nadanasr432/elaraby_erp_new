        ...
        <div class="row">
            ...
            <div class="px-2 d-flex flex-wrap">
                ...
                <a class="nav-link text-dark" style="border:1px solid #bbb"
                    href="{{ route('client.extra.settings.edit') }}">
                            ...
                            <div class="col-lg-4 col-xs-12 pull-right">
                                <div class="form-group">
                                    ...
                                    <input style="width:100%" readonly type="text" class="form-control"
                                        dir="ltr" value="{{ $fiscal->fiscal_year }}" name="fiscal_year"
                                        id="fiscal_year" />
                                </div>
                            </div>
                            <div class="col-lg-4 col-xs-12 pull-right">
