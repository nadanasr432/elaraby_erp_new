                ...
                <div class="card-body">
                    ...
                    <div class="row" style="padding: 12px; border: 1px solid gray; margin: 10px;">
                        <div class="col-6" style="border-left:1px solid gray;">
                            <span
                                style="font-size: 18px !important; color: black; font-weight: 600 !important; margin-left: 11px;">
                                {{ __('bonds.client_name') }} :</span>
                            <span
                                style="font-size: 17px !important;color:color: #5c5858; font-weight: 600;">{{ $clientBond->client }}</span>
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            <span style="font-size: 17px !important;color: #5c5858; font-weight: 600;">
                                @if ($clientBond->account == 'النقدية في الخزينة')
                                    كاش
                                @elseif ($clientBond->account == 'العقد النقدية')
                                    شبكه
                                @elseif ($clientBond->account == 'حساب البنك الجاري')
                                    تحويل بنكي
                                @else
                                    {{ $clientBond->account }}
                                @endif
                    ...
                    <div class="row" style="padding: 12px; border: 1px solid gray; margin: 10px;">
                        <div class="col-6" style="border-left:1px solid gray;">
                            <span
                                ...
                                :</span>
                            <span
                                style="font-size: 17px !important;color: #5c5858; font-weight: 600;">{{ $clientBond->type }}</span>
                        </div>

                        <div class="col-6">
                            <span
                                style="font-size: 18px !important; color: black; font-weight: 600 !important; margin-left: 11px;@if (Config::get('app.locale') == 'en') float:right; @endif">{{ __('bonds.date') }}
                                :</span>
                            <span
                                style="font-size: 17px !important;color: #5c5858; font-weight: 600;">{{ $clientBond->date }}</span>
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding: 12px; border: 1px solid gray; margin: 10px;">
                        <div class="col-6" style="border-left:1px solid gray;">
                            <span
                                ...
                                :</span>
                            <span
                                style="font-size: 17px !important;color: #5c5858; font-weight: 600;">{{ $clientBond->amount }}</span>
                        </div>
                        <div class="col-6" style="border-left:1px solid gray;">
                            <span
                    ...
                    <div class="row" style="margin: 10px;">
                        ...
                        <button id="backk"
                            onclick="window.location.href='https://elaraby-erp.net/ar/client/clients-bonds/index'"
