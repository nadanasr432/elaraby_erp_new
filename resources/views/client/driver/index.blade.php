                        ...
                        <table class="table table-striped table-bordered zero-configuration" id="example-table"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0 text-center">{{ __('main.name') }}</th>
                                    <th class="wd-20p border-bottom-0 text-center">{{ __('main.iqama_number') }}</th>
                                    <th class="wd-15p border-bottom-0 text-center">{{ __('main.nationality') }}</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($drivers as $key => $driver)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('drivers.edit', $driver->id) }}" class=" "
                                            ...
                                            <a class="modal-effect delete_driver" data-id="{{ $driver->id }}"
                                                data-name="{{ $driver->country }}" data-toggle="modal" href="#modaldemo9"
            ...
            <div class="modal-dialog modal-dialog-centered" supplier="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header text-center">
                        <h6 class="modal-title w-100" style="font-family: 'Cairo'; ">@lang('main.delete_driver')  </h6>
...
<script>
    $(document).ready(function() {
        $('.delete_driver').click(function() {
            ...
            let actionUrl = "{{ route('drivers.destroy', ':id') }}".replace(':id',
            driverId);
