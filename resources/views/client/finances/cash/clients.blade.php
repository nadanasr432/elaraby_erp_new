        ...
        <div class="card mg-b-20">
            <div class="card-body">
                <div class="col-12 d-flex flex-wrap justify-content-between align-items-center">
                    ...
                    <a class="btn btnn text-white px-3 py-1" style="background-color: #ec6880" href="{{ route('client.cash.clients') }}">
                ...
                <form class="parsley-style-1" id="selectForm2" name="selectForm2"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input required readonly value="{{ $pre_cash }}" class="form-control" name="cash_number"
                                type="text">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input required class="form-control" name="amount" type="number" min="0" step="0.01"
                                dir="ltr">
                        </div>
                    </div>
                    <div class="row mb-3">
