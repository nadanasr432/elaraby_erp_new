                ...
                <div class="card-header pb-0">
                    <div class="col-lg-12 margin-tb d-flex flex-wrap align-items-center justify-content-between">
                        <h5 class=" alert custom-title">
                            {{ __('sidebar.list-of-vehicle-vehicles') }}</h5>
                        <a class="btn btnn text-white px-3 py-1" style="background-color:#36c7d6""
                            href="{{ route('vehicles.create') }}">
                            <i class="fa fa-plus"></i> {{ __('sidebar.add-new-vehicle') }} </a>
                        ...
                        <table class="table table-striped table-bordered zero-configuration" id="example-table"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0 text-center">{{ __('main.vehicle_number') }}</th>
                                    <th class="wd-20p border-bottom-0 text-center">{{ __('main.plate_number') }}</th>
                                    <th class="wd-15p border-bottom-0 text-center">{{ __('main.trailer_type') }}</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($vehicles as $key => $vehicle)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('vehicles.edit', $vehicle->id) }}" class=" "
                                            ...
                                            <a class="modal-effect delete_vehicle" data-id="{{ $vehicle->id }}"
                                                data-name="{{ $vehicle->country }}" data-toggle="modal" href="#modaldemo9"
            ...
            <div class="modal-dialog modal-dialog-centered" supplier="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header text-center">
                        <h6 class="modal-title w-100" style="font-family: 'Cairo'; ">@lang('main.delete_vehicle')  </h6>
...
<script>
    $(document).ready(function() {
        $('.delete_vehicle').click(function() {
            ...
            let actionUrl = "{{ route('vehicles.destroy', ':id') }}".replace(':id',
            vehicleId);
