        ...
        <div class="card mg-b-20">
            <div class="card-body">
                ...
                <form class="parsley-style-1 no-print" id="selectForm2" name="selectForm2"
                    action="{{route('employees.summary.post')}}" enctype="multipart/form-data" method="post">
                    {{csrf_field()}}
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <select required name="employee_id" id="employee_id" class="selectpicker"
                                ...
                                @foreach($employees as $employee)
                                    <option @if(isset($employee_id) && $employee_id == $employee->id) selected @endif
                        ...
                        <div class="col-md-4">
                            ...
                            <input required type="date" @if(isset($from_date) && !empty($from_date))
                                value="{{$from_date}}" @else value="{{date('Y-m-01')}}" @endif class="form-control"
                                name="from_date" />
                        </div>
                        <div class="col-md-4">
                            <label class="d-block"> الى تاريخ <span class="text-danger">*</span></label>
                            <input required @if(isset($to_date) && !empty($to_date)) value="{{$to_date}}" @else
                                value="{{date("Y-m-t", strtotime(date('Y-m-d')))}}" @endif type="date"
                ...
                @if(isset($employee_k))
                    ...
                    $salary = (float) $employee_k->salary; // Cast salary to float
                    $total_salary = $salary * $diff;

                    echo number_format($total_salary, 2) . " " . $currency; // Format total_salary with 2 decimal places
                                                        ?>
                                                </td>
