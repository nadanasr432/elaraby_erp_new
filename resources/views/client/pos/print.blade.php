...
<body dir="rtl"
        ...
        <div class="text-right mt-3">
            ...
            <div class="visible-print text-right mt-2 mr-2">
                ...
                $displayQRCodeAsBase64 = GenerateQrCode::fromArray([
                    ...
                    new InvoiceTaxAmount(number_format($percent, 2, '.', '')), // invoice tax amount
    ...
    <button onclick="window.print();" style="width: 150px; height: 150px; class="no-print btn btn-md btn-success">اضغط
        للطباعة</button>
    <a href="{{ route('client.pos.create') }}" class="no-print btn btn-md btn-danger" style="left:200px!important;">
        العودة
        الى نقطة البيع
    </a>
