...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-6  pull-right">
            <div class="section">
                    ...
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        @if ($pos_settings->edit_delete_tab == '1')
                            <a class="nav-item nav-link" id="nav-bills-tab" data-toggle="tab" href="#nav-bills"
                                ...
                                {{ __('pos.modify-previous-invoices') }}
                            </a>
                        @endif
                ...
                <div class="mb-1">
                    <select autofocus id="product_id" class="col-8 selectpicker form-control" data-style="btn-dark"
                    ...
                    @endif
                    <a style="width: 5%;display: inline; border-radius: 0;margin-right: 3px;" class="btn btn-sm btn-success"
                        href="pos-sales-report">
                        تقرير اليوم
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="row mt-1">
                            ...
                            @foreach ($categories as $category)
                                <a class="category col-lg-2 pull-right text-center"
                                ...
                                @if ($pos_settings->status == 'open')
                                    @if ($pos_status == 'none')
                                        <span class="fixed-bottom"
                                            style="margin-right: 200px!important; padding-bottom: 10px;
                        ...
                        <tr>
                            @if ($pos_settings->tax == '1')
                                <td style="padding: 5px 10px;">
                                    ...
                                    <span class="text-danger noTaxAddedMsg font-weight-bold ml-2"
                                        style="display: none;">(لم يتم اضافة ضريبة)</span>
                                    <br>
            ...
            <div class="modal-content modal-content-demo">
                ...
                <div class="row extra_div bank">
                    ...
                    <div class="col-md-12 p-2">
                        ...
                        <select style="width: 90% !important; display: inline !important;" id="fast_bank_id"
                            class="form-control" required>
                            <option value="">{{ __('banks.bank-name') }}</option>
                            @foreach ($banks as $bank)
                                <option value="{{ $bank->id }}">{{ $bank->bank_name }}</option>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 text-center mb-2">
                    <button class="btn btn-info finishBank" type="button">
                        {{ __('banks.record-process') }}
                    </button>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="number" dir="ltr" class="form-control text-right"
                            @if (isset($pos_open) && !empty($pos_open_discount)) value="{{ $pos_open_discount->discount_value }}" @endif
                ...
                <div class="modal-body">
                    <div class="col-lg-6 pull-right">
                        ...
                        <div class="form-group pull-right col-lg-12" dir="rtl">
                            ...
                            <input type="number" value="0" id="prev_balance" class="form-control"
                                dir="ltr" />
                        </div>
                        <div class="form-group pull-right col-lg-12" dir="rtl">
                            <label for="address">
                            ...
                            <input type="text" value="" id="client_address" class="form-control"
                                dir="rtl" />
                        </div>
                    ...
                    <div class="col-lg-6  pull-left">
                        ...
                        <div class="form-group pull-right col-lg-12" dir="rtl">
                            ...
                            <input type="number" value="" id="client_phone" class="form-control"
                                dir="ltr" />
                        </div>
                        <div class="clearfix"></div>
                    </div>
                ...
                <div class="modal-body">
                    <div class="col-lg-6 pull-right">
                        ...
                        <div class="form-group  col-lg-12  pull-right" dir="rtl">
                            ...
                            <input type="text" value="{{ $code_universal }}" class="form-control text-left"
                                dir="ltr" id="code_universal" />
                        </div>
                        <div class="clearfix"></div>
                        <div class="form-group  col-lg-12  pull-right" dir="rtl">
    ...
    <input type="hidden" id="final_total"
        @if (isset($pos_open)) value="{{ $sum }}" @else value="0" @endif />
    <input type="hidden" value="{{ date('Y-m-d') }}" id="date" />
    <input type="hidden" value="{{ date('h:i:s') }}" id="time" />
    <input type="hidden" id="sale_bill_number"
        @if (isset($pos_open)) value="{{ $pos_open->id }}"
        @else
        value="0" @endif>
    ...
    $(document).ready(function() {
        ...
        $('#product_id').on('change', function() {
            ...
            if ($("#" + product_id).length == 0) {
                ...
                var productRow = '<tr id="' + product_id + '"> <td>' + product_name +
                    '</td> <td><input type="number" id="edit_price-' + product_id +
                    '" class="edit_price w-100" value="' + product_price +
                    '"></td> <td><input type="number" id="edit_quantity-' + product_id +
                    '" class="edit_quantity w-100" value="1"></td> <td><input type="number" id="edit_discount-' +
                    product_id + '" class="edit_discount w-100" value="0"></td> <td id="totalPrice-' +
                    product_id + '" class="totalPrice">' + product_price +
                ...
                $.post("{{ route('getNewPosBillID') }}", function(data) {
                    ...
                    if (payment_method == "") {
                        ...
                        $.post("{{ route('client.store.cash.clients.pos', 'test') }}", {
                            ...
                            if (data.status == true) {
                                $('<div class="alert alert-dark alert-sm"> ' + data
                                        .msg + '</div>')
                                    .insertAfter('#company_id');

                                $('.delete_pay').on('click', function() {
                                    let payment_method = $(this).attr(
                                        'payment_method');
                                ...
                                $('<p class="alert alert-danger alert-sm"> ' + data
                                        .msg + '</p>')
                                    .insertAfter('#company_id');
                            }
                        });
