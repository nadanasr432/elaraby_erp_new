...
<body>
    <div class="invoice-container border mt-4">
        ...
        <div class="all-data" style="border-top: 1px solid #2d2d2d20;padding-top: 25px;">
            ...
            @php
                $clients = $company->outerClients;
                $clientCount = $clients->count();
                $saleBillClientId = $sale_bill->outerClient->id ?? null;
                $clientIndex = $clients->search(function ($client) use ($saleBillClientId) {
                    return $client->id == $saleBillClientId;
                });
                $clientNumber = $clientIndex !== false ? $clientIndex + 1 : 'N/A';
            @endphp
            <div class="invoice-information row justify-content-around mt-3" style=" padding: 0px 24px;">
                <div class="col-12 pr-2 pl-2">
                    <table style="width: 100%;">
                        <tr class="d-flex pt-1"
                            ...
                            <td width="50%" class="d-flex justify-content-between text-right pr-2">
                                <div style="display: flex; justify-content: space-between;">
                                    <span style="text-align: left;"> رقم العميل : <span
                                            style="text-align: right;">(00{{ str_pad($clientNumber, 2, '0', STR_PAD_LEFT) }})</span><br>Client
                                        Number</span>
                                </div>
                                بيانات العميل
                                <br>
                            ...
                            <td width="50%" class="text-right pr-2">فاتورة من <br> invoice from</td>
                        </tr>
                    </table>
                </div>
                <div class="left pr-2 pl-2" style="right: -5px;position:relative;border-bottom: 1px solid #25252525;">
                    <table style="width: 100%;">
                        <tr class="d-flex bordernone">
                            ...
                            <td width="40%" class="text-right"> (Client Name) اسم العميل </td>
                        </tr>
                        <tr class="d-flex pt-1 bordernone">
                            <td width="60%" class="text-left">{{ $sale_bill->outerClient->tax_number ?? '-' }}
                            </td>
                            <td width="40%" class="text-right"> (Tax Number) الرقم الضريبي </td>
                        </tr>
                        <tr class="d-flex pt-1 bordernone">
                            <td width="60%" class="text-left">
                                {{ $sale_bill->outerClient->phones[0]->client_phone ?? '-' }}</td>
                            <td width="40%" class="text-right"> (Phone) الهاتف </td>
                        </tr>
                        <tr class="d-flex pt-1 bordernone">
                            <td width="60%" class="text-left">
                                {{ $sale_bill->outerClient->addresses[0]->client_address ?? '-' }}</td>
                            <td width="40%" class="text-right">(Address) العنوان </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="right pr-2 pl-2"
                    ...
                    <table style="width: 100%;">
                        <tr class="d-flex bordernone">
                            <td width="50%" class="text-left">{{ $company->company_name }}</td>
                            <td width="50%" class="text-right"> (Company Name) اسم الشركة </td>
                        </tr>
                        <tr class="d-flex pt-1 bordernone">
                ...
                <table class="invoice-information"
                    ...
                    <thead>
                        <tr
                            ...
                            <th>المبلغ غير شامل الضريبة <br>The amount does not include tax</th>
                            <th>العدد<br> Quantity</th>
                            <th>السعر<br>Unit price</th>
                            <th>البيان <br>Name</th>
                            <th>الرقم <br>No</th>
                        </tr>
            ...
            <div class="row px-4 pt-2 d-flex justify-content-between">
                ...
                <div class="products-details p-0 col-7"
                    ...
                    <table
                        ...
                        <tr
                            ...
                            <td dir="rtl">
                                ...
                                @else
                                    @if ($realtotal > 0)
                                        {{ $sumWithOutTax }} <img src="{{ asset('images/Sr_coin.svg') }}"
                                            width="5%">
                                    @endif
                        ...
                        @if (!empty($ifThereIsDiscountNote))
                            <tr
                                ...
                                <td style="text-align: right;padding-right: 14px;">:(Discount note) ملاحظات الخصم </td>
                            </tr>
                        @endif
                        ...
                        <tr
                            style="border-bottom:1px solid #2d2d2d30;font-weight: bold;font-size:18px !important; height: 37px !important; text-align: center;background: #f8f9fb">
                            @if ($company->tax_value_added && $company->tax_value_added != 0)
                                <td dir="rtl">{{ $totalTax }} <img src="{{ asset('images/Sr_coin.svg') }}"
                                        width="5%"> </td>
                            @else
                                <td dir="rtl">0 <img src="{{ asset('images/Sr_coin.svg') }}" width="5%">
                                </td>
                            @endif
                        ...
                        <tr
                            ...
                            @endif
                            <td style="text-align: right;padding-right: 14px;">(Total) الإجمالي</td>
                        </tr>
                        <tr
                            style="border-bottom:1px solid #2d2d2d30;font-weight: bold;font-size:18px !important; height: 37px !important; text-align: center;background: #f8f9fb">
