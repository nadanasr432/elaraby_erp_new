                ...
                <div class="container">
                    ...
                    if (!$elements->isEmpty()) {
                        foreach ($elements as $element) {
                            ...
                            $priceWithoutTax = ($sale_bill->value_added_tax ? round(($element->quantity_price * 20) / 23, 2) : $element->quantity_price);
                            ?>
                            <tr class="text-muted"
                                ...
                                <td><?php echo $element->product_price; ?></td>
                                <td><?php echo $element->product->product_name; ?></td>
                            </tr>
                            <?php
                            }
                                }
