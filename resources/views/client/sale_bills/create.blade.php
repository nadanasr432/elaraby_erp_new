...
@section('content')
    ...
    <form target="_blank" action="#" method="POST">
        ...
        <div class="col-lg-3 pull-right">
            ...
            <select name="store_id" id="store_id" class="selectpicker w-100" data-style="btn-primary"
...
@endif
        ...
        <div class="options no-print">
            <div class="col-lg-3 pull-right">
                ...
                <select name="product_id" id="product_id" class="selectpicker w-100" data-style="btn-success"
