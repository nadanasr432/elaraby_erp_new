...
<form action="{{route('client.sale_bills.post.return')}}" method="post">
    ...
    <div class="row mt-2 mb-2">
        <div class="col-lg-3 pull-right no-print">
            ...
            <input type="hidden" @if(empty($sale_bill->outer_client_id)) value="" @else
                value="{{$sale_bill->OuterClient->id}}" @endif required name="outer_client_id" id="outer_client_id" />
            <input type="text" class="form-control" readonly @if(empty($sale_bill->outer_client_id))
            value="عميل مبيعات نقدية" @else value="{{$sale_bill->OuterClient->client_name}}" @endif />
        </div>
        <div class="col-lg-3 pull-right no-print">
    ...
    <div class="row mt-1 mb-1">
        ...
        <div class="col-lg-3 pull-right">
            <div class="form-group" dir="rtl">
                ...
                <input type="text" name="before_return" id="before_return" value="{{$element->product->first_balance}}"
    ...
    <div class="row mt-1 mb-1">
        <div class="col-lg-3 pull-right">
            <div class="form-group" dir="rtl">
                ...
                <input type="text" readonly value="{{$element->product_price}}" name="product_price" id="product_price"
        ...
        <div class="col-lg-3 pull-right">
            <div class="form-group" dir="rtl">
                ...
                <input type="text" name="balance_before" id="balance_before" @if(empty($sale_bill->outer_client_id))
                    value="0" @else value="{{$sale_bill->OuterClient->prev_balance}}" @endif class="form-control"
                    readonly required>
            </div>
        </div>
        ...
        <div class="col-lg-3 pull-right">
            <div class="form-group" dir="rtl">
                ...
                <input type="text" name="balance_after" @if(empty($sale_bill->outer_client_id)) value="0" @endif
