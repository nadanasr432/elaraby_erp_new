        ...
        <tbody>
            <tr>
                <td class="thisTD">
                    <center style="margin:20px auto;">
                        @if (!empty($sale_bill->outer_client_id))
                            <span
                                style="font-size:18px;font-weight:bold; border:5px solid #333; padding: 5px 10px;  background-color:yellow;">فاتورة
                                ضريبية TAX INVOICE</span>
                        @else
                            <span
                                style="font-size:18px;font-weight:bold;border:3px solid #ddd; padding: 5px 10px; background-color:yellow;">
                                فاتورة ضريبية مبيعات نقدية </span>
                        @endif
                    </center>
                    <?php
                    ...
                    if (!$elements->isEmpty()) {
                        echo '<h6 class="alert alert-sm alert-info text-center">
                                 ...
                                 <span style="font-size:18px;font-weight:bold; border:5px solid #333; padding: 5px 20px; background-color:yellow;">بيانات عناصر الفاتورة رقم ' .
                    ...
                    echo "<table class='table table-bordered' style='font-size:12px;'>
                                    <tr>
                                        <td>الاجمالي بدون الضريبة: " .
                        round($totalAfterDisountt, 2) .
                        '  ' .
                        $currency .
                        '</td>';
                    echo '<td>';
                    foreach ($extras as $key) {
                        if ($key->action == 'discount') {
                            ...
                            } elseif ($key->action_type == 'afterTax') {
                                echo ' خصم ' . $key->value . ' % ';
                                echo "<span style='margin-right:20px;border-right:1px solid gray;padding-right: 15px;'>
                                                " .
                                    round(($key->value * $total) / 100, 2) .
             ...
             ***********/
                    ...
                    echo "<tr>
                        ...
                        "% ) </td>
                                    <td> " .
                        round($sale_bill->final_total - $totalAfterDisountt, 2) .
                        ' ' .
                        $currency .
                        " </td>
                                </tr>";
                    ...
                    echo "<tr style='text-align:center;'>
                                        <td style='border:2px solid #000;''text-align:center;' colspan='2'> المبلغ المتبقى : " .
                        $rest .
                        ' ' .
                        $currency .
                        " </td>
                    ...
                    <div class="text-center mt-2 mb-2">
                        ...
                        @endphp
                        @if (!$isMoswada)
                            <img src="{{ $displayQRCodeAsBase64 }}" style="width: 150px; height: 110px;"
                                alt="QR Code" />
                        @endif
                    ...
                    <td>
                        <div class="products-details p-2 col-12">
                            <table
                                ...
                                <tbody>
                                    <tr
                                        style="border-bottom:1px solid #2d2d2d30;font-weight: bold;font-size: 15px !important; height: 44px !important; text-align: center;background: #007bff;color:white;">
                                        <td style="text-align: right;padding-right: 14px;" colspan="2">الشروط
                                            والاحكام</td>
                                    </tr>
                                    <tr
