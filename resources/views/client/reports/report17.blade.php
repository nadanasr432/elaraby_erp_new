                        ...
                        <div class="row mb-3">
                            <div class="col-lg-4 mb-3 no-print">
                                ...
                                <select required name="type" id="type" class="form-control">
                                    <option @if (isset($type) && $type == 'all') selected @endif value="all">كل العمليات
                                    </option>
                                    <option @if (isset($type) && $type == 'purchases') selected @endif value="purchases">مشتريات
                                    </option>
                                    <option @if (isset($type) && $type == 'sales') selected @endif value="sales"> مبيعات
                                    </option>
                                    <option @if (isset($type) && $type == 'payments') selected @endif value="payments">مدفوعات
                                    </option>
                                </select>
                            </div>
                            <div class="col-lg-4 mb-3 no-print">
