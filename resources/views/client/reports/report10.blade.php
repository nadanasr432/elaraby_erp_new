                    ...
                    <form action="{{ route('client.report10.post') }}" method="POST" onsubmit="return validateForm()">
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-4 mb-3 no-print">
                                ...
                                <select name="product_id" id="product_id" class="form-control selectpicker p-0" 
                        ...
                        <div class="">
                            <button class="btn btnn btn-md btn-warning"
                                type="submit">
...
<script>
    function validateForm() {
        ...
        if (!productId) {
            alert('يرجى اختيار منتج قبل تقديم الطلب');
            return false;
        }
        return true;
    }
