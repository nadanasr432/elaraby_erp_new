                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('client.report2.post') }}" class="no-print" method="POST">
                        ...
                        <div class="col-lg-3 pull-right no-print">
                            ...
                            <select required name="product_id" id="product_id" class="selectpicker" data-style="btn-info"
                    ...
                    @if (isset($posBills) && !empty($posBills))
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @foreach ($pos->elements as $element)
                                                    <?php
                                                    $elementCost = $element->product?->purchasing_price ?? 0;
                                                    $merchandise_cost = $merchandise_cost + $elementCost * $element->quantity;
                                                    ?>
                                                @endforeach
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="badge badge-success p-1" style="width: auto;font-weight: bold;margin-right:4px;">
                            ...
                            <div class="badge badge-primary p-1" style="width: auto;font-weight: bold;margin-right:4px;">
