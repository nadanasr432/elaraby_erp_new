<?php $__env->startSection('content'); ?>
    ...
    <form id="myForm" target="_blank" action="#" method="POST">
        ...
        <h6 class="alert alert-info alert-sm text-center no-print  font-weight-bold" dir="rtl"
            ...
            <center>
                <?php echo e(__('sidebar.edit-sales-invoice')); ?> <?php echo e($saleBill->sale_bill_number); ?>
            ...
            <div class="col-md-6 pull-right no-print">
                <div class="form-group" dir="rtl">
                    ...
                    <input type="date" required name="date" id="date" class="form-control"
                        value="<?php echo e($saleBill->date ?? date('Y-m-d')); ?>" />
                </div>
            </div>
            ...
            <div class="col-md-6 pull-right no-print">
                <div class="form-group" dir="rtl">
                    ...
                    <input type="time" required name="time" id="time" class="form-control"
                        value="<?php echo e($saleBill->time ?? date('H:i:s')); ?>" />
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <select name="outer_client_id" id="outer_client_id" data-style="btn-new_color"
                        ...
                        <?php $__currentLoopData = $outer_clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outer_client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php echo e($saleBill->outer_client_id == $outer_client->id ? 'selected' : ''); ?>

                                value="<?php echo e($outer_client->id); ?>"><?php echo e($outer_client->client_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                ...
                <div class="d-flex justify-content-between">
                    <select name="store_id" id="store_id" class="selectpicker me-2" data-style="btn-new_color"
                        ...
                        <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php echo e($saleBill->store_id == $store->id ? 'selected' : ''); ?> value="<?php echo e($store->id); ?>">
                                <?php echo e($store->store_name); ?></option>
                            <?php $i++; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <a target="_blank" href="<?php echo e(route('client.stores.create')); ?>" role="button" class="btn btn-primary ">
                        <i class="fa fa-plus" aria-hidden="true"> </i>
                        <?php echo e(__('sales_bills.add-store')); ?>
            ...
            <div class="col-md-6 pull-right no-print">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <select name="product_id" id="product_id" class="selectpicker w-50" data-style="btn-new_color"
                        data-live-search="true" title="<?php echo e(__('sales_bills.product-code')); ?>">
                        <option value="new" style="color: red;"><?php echo e(__('sales_bills.Add immediate product')); ?></option>
            ...
            <div class="col-md-6 pull-right no-print">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <select required name="value_added_tax" id="value_added_tax" class="selectpicker w-100"
                        ...
                        <option <?php echo e($saleBill->value_added_tax == '0' ? 'selected' : ''); ?> value="0">
                            <?php echo e(__('sales_bills.not-including-tax')); ?></option>
                        <option <?php echo e($saleBill->value_added_tax == '2' ? 'selected' : ''); ?> value="2">
                            <?php echo e(__('sales_bills.including-tax')); ?></option>
                        <option <?php echo e($saleBill->value_added_tax == '1' ? 'selected' : ''); ?> value="1">
        ...
        <input type="number" value="<?php echo e($saleBill->sale_bill_number); ?>" name="sale_bill_number" hidden>
            ...
            <table class="table table-bordered mt-2" id="products_table"
                ...
                <thead>
                    <tr>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('الخصم')): ?>
                            <th
                                ...
                                <div class="tax_discount"
                                    ...
                                    <select id="discount_application" class="form-control"
                                        ...
                                        <option <?php echo e($saleBill->products_discount_type == 'before_tax' ? 'selected' : ''); ?>

                                            value="before_tax"><?php echo e(__('sales_bills.discount_before_tax')); ?></option>
                                        <option <?php echo e($saleBill->products_discount_type == 'after_tax' ? 'selected' : ''); ?>

                                            value="after_tax"><?php echo e(__('sales_bills.discount_after_tax')); ?></option>
                                    </select>
                                </div>
                            </th>
                        <?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('الخصم')): ?>
                    <div class="form-group" dir="rtl">
                        ...
                        <select name="discount_type" id="discount_type" class="form-control"
                            ...
                            <option <?php echo e($discount?->action_type == 'pound' ? 'selected' : ''); ?> value="pound">خصم قبل الضريبة
                                (مسطح)</option>
                            <option <?php echo e($discount?->action_type == 'percent' ? 'selected' : ''); ?> value="percent">خصم قبل
                                الضريبة (%)</option>
                            <option <?php echo e($discount?->action_type == 'poundAfterTax' ? 'selected' : ''); ?> value="poundAfterTax">
                                ضمان اعمال (مسطح)</option>
                            <option <?php echo e($discount?->action_type == 'poundAfterTaxPercent' ? 'selected' : ''); ?>

                                value="poundAfterTaxPercent">ضمان اعمال (%)</option>
                            <option <?php echo e($discount?->action_type == 'afterTax' ? 'selected' : ''); ?> value="afterTax"
                                class="d-none">
                        ...
                        <input type="number" name="discount_value" min="0"
                            ...
                            value="<?php echo e($discount?->value); ?>" step = "any" />
                        <input type="text" name="discount_note" value="<?php echo e($discount?->discount_note); ?>"
            ...
            <div class="col-md-6 pull-right">
                <div class="form-group" dir="rtl">
                    ...
                    <select name="extra_type" id="extra_type" class="form-control"
                        ...
                        <option <?php echo e($shipping?->action_type == 'pound' ? 'selected' : ''); ?> value="pound">
                            <?php echo e($extra_settings->currency); ?></option>
                        <option <?php echo e($shipping?->action_type == 'percent' ? 'selected' : ''); ?> value="percent">%</option>
                    </select>
                    <input type="number" name="extra_value" min='0'
                        style="width: 20%;display: inline;float: right;" id="extra_value" class="form-control"
                        value="<?php echo e($shipping?->value); ?>" step = "any" />
                </div>
            </div>
        </div><!--  End Row -->
        <!-----notes------->
        ...
        <div class="col-lg-12 no-print text-center"
            ...
            <button type="button" id="add" class="btn btn-info btn-md ml-1" style="height: 40px;">
                ...
                <?php echo e(__('sales_bills.update')); ?>
    ...
    <script>
        ...
        window.canDiscount = <?php echo json_encode(auth()->check() && auth()->user()->can('الخصم'), 15, 512) ?>;
    </script>
    <script>
        // Initialize rowIndex with the current count of existing rows
        var rowIndex = <?php echo e(count($saleBill->elements)); ?>;

        // Function to populate existing elements into the table
        <?php $__currentLoopData = $saleBill->elements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            var rowHtml = `
            <tr data-product-id="<?php echo e($element->product_id); ?>" data-index="<?php echo e($index); ?>">
                <td><?php echo e($element->product->product_name); ?></td>
                <td class="text-left">
                    <label>
                        <input type="radio" name="products[<?php echo e($index); ?>][price_type]" required value="sector" class="price_type" <?php echo e($element->price_type == 'sector' ? 'checked' : ''); ?>>
                        ${translations.sector}
                    </label>
                    <label>
                        <input type="radio" name="products[<?php echo e($index); ?>][price_type]"  required value="wholesale" class="price_type" <?php echo e($element->price_type == 'wholesale' ? 'checked' : ''); ?>>
                        ${translations.wholesale}
                    </label>
                </td>
                <td>
                    <input type="number" min="1" name="products[<?php echo e($index); ?>][product_price]" class="form-control price" value="<?php echo e($element->product_price); ?>" step="any">
                </td>
                <td>
                    <input type="number" name="products[<?php echo e($index); ?>][quantity]" class="form-control quantity" value="<?php echo e($element->quantity); ?>" min="1" max="<?php echo e($element->remaining); ?>" step="any">
                </td>
                <td>
                    <select name="products[<?php echo e($index); ?>][unit_id]" class="form-control unit">
                        <option disabled>${translations.choose_unit}</option>
                        <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($unit->id); ?>" <?php echo e($element->unit_id == $unit->id ? 'selected' : ''); ?>><?php echo e($unit->unit_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </td>
            ${canDiscount ? `
                            <td>
                                <label>
                                    <input type="radio" name="products[<?php echo e($index); ?>][discount_type]" value="pound" class="discount_type" <?php echo e($element->discount_type == 'pound' ? 'checked' : ''); ?>>
                                    ${translations.pound}
                                </label>
                                <label>
                                    <input type="radio" name="products[<?php echo e($index); ?>][discount_type]" value="percent" class="discount_type" <?php echo e($element->discount_type == 'percent' ? 'checked' : ''); ?>>
                                    ${translations.percent}
                                </label>
                                <input
                                    type="number"
                                    name="products[<?php echo e($index); ?>][discount]"
                                    class="form-control discount"
                                    value="<?php echo e($element->discount_value == 0 ? 0 : ($element->discount_type == 'percent' ? $element->discount_value : $element->discount_value)); ?>"
                                    min="0"
                                    step="any">

                                <input type="number" hidden name="products[<?php echo e($index); ?>][applied_discount]" class="form-control applied_discount" value="<?php echo e($element->applied_discount); ?>" style="display:none;" step="any">
                            </td>
                                            ` : ''}
                <td>
                    <select name="products[<?php echo e($index); ?>][tax]" class="form-control tax_type w-100 mb-1">
                        <option value="0" <?php echo e($element->tax_type == 0 ? 'selected' : ''); ?>>${translations.not_including_tax}</option>
                        <option value="1" <?php echo e($element->tax_type == 1 ? 'selected' : ''); ?>>${translations.exempt_tax}</option>
                        <option value="2" <?php echo e($element->tax_type == 2 ? 'selected' : ''); ?>>${translations.including_tax}</option>
                    </select>
                    <input type="number" readonly name="products[<?php echo e($index); ?>][tax_amount]" class="form-control tax_amount" value="<?php echo e($element->tax_value); ?>" min="0" step="any">
                </td>
                <td>
                    <input type="number" name="products[<?php echo e($index); ?>][total]" class="form-control total" value="<?php echo e($element->quantity_price); ?>" readonly step="any">
                    <input type="number" hidden name="products[<?php echo e($index); ?>][product_id]" class="form-control total" value="<?php echo e($element->product_id); ?>">
                </td>
                <td>
  ...
  `;
        ...
        $(document).ready(function() {
            ...
            $('.save_btn1').on('click', function() {
                ...
                $.post("<?php echo e(url('/client/sale-bills/saveAll')); ?>", formData, function(data) {
        ...
        $(document).ready(function() {
            ...
            $('#add').on('click', function(e) { // Add 'e' as the event parameter
                ...
                var formData = $('#myForm').serialize();
                $.post("<?php echo e(url('/client/sale-bills/update')); ?>", formData)
                    .done(function(data) {
                        if (data.status === true) {
...
<?php echo $__env->make('client.layouts.app-main1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/elaraby_erp_new/resources/views/client/sale_bills1/edit.blade.php ENDPATH**/ ?>