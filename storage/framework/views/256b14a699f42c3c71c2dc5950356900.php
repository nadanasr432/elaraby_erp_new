...
<?php $__env->startSection('content'); ?>
    ...
    <section class="banner-section" style="padding-bottom: 0px; padding-top: 150px;">
        ...
        <div class="container m-0 mx-auto">
            <div class="row <?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> flex-row-reverse <?php endif; ?>">
                <div class="col-sm-6 banner-content pr-4">
                    <?php if(session('error')): ?>
                        <div class="alert alert-danger fade show">
                            <?php echo e(session('error')); ?>

                            <a class="dropdown-item" href="<?php echo e(route('client.logout')); ?>"
                               onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                <i class="fa fa-power-off"></i> <?php echo e(__('main.logout')); ?>
                    ...
                    <img style="position: absolute; width: 32px; right: 22px;" src="<?php echo e(asset('images/sq.png')); ?>">
                    <img style="position: absolute; width: 32px; right: 422px;"
                         src="<?php echo e(asset('images/circ.png')); ?>">

                    <h2 class="h1heading  animate__backInRight" style="animation-duration: 2s">
                        <?php echo e(__('main.best-option')); ?>

                    </h2>
                    <p class="p-main-sec1 animate__backInRight"
                       style="animation-duration: 2.4s"><?php echo e(__('main.best-option-p')); ?></p>
                    <img class="animate__backInRight"
                         ...
                         src="<?php echo e(asset('images/poin.png')); ?>">


                    <h3 class="text-white h3heading animate__backInRight" style="animation-duration: 2.6s">
                        <?php echo e(__('main.certified')); ?>

                    </h3>
                    <img
                        style="animation-duration: 2.8s;width: 83%; <?php if(LaravelLocalization::getCurrentLocale() == "en"): ?> float: left;  <?php else: ?> float: right; <?php endif; ?> margin-top: 6px;margin-bottom: 26px;"
                        src="<?php echo e(asset('images/hay2a.png')); ?>"
                        class="animate__backInRight">
                        ...
                        <?php if(!auth()->guard('client-web')->check() && !auth()->guard('admin-web')->check()): ?>
                            ...
                            <div class="col-6 p-0">
                                <a class="subscribNow loginBtnAni"
                                    style="color: white;padding: 10px 20px !important;min-width: 225px;"
                                    href="<?php echo e(route('client.login')); ?>">
                ...
                <div class="col-sm-6 mt-sm-0 mt-4">
                    <div class="img-viewer-app text-center mt-3">
                        <img class="img-fluid" src="<?php echo e(asset('images/main-app.png')); ?>">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 p-0">
            <img class="fadeBottom" style="height: 226px; width: 108%; margin-top: -29px;"
                 src="<?php echo e(asset('images/fadeFooter.png')); ?>">
        </div>
    </section>
    <!-- ==========Banner-Section========== -->
                ...
                <div class="col-lg-6 d-flex flex-column justify-content-center p-5">
                    ...
                    <div class="icon-box">
                        ...
                        <h4 class="title"><a href="">
                                <?php echo e(__('index.what-is-elaraby-erp')); ?>

                            </a></h4>
                        <p class="description">
                            <?php echo e(__('index.elaraby-erp-integrated-project-management-shops-and-warehouses')); ?>
                    ...
                    <div class="icon-box">
                        ...
                        <h4 class="title"><a href="">
                                <?php echo e(__('index.what-is-benefits')); ?>

                            </a></h4>
                        <p class="description">
                            <?php echo e(__('index.save-your-time-and-effort-and-start-managing-your-business-professionally')); ?>
    ...
    <div class="overlays text-center justify-content-center">
        ...
        <video id='myvideo' controls>
            <source media="all"
                    <?php if(isset($intro_movie)): ?> src="<?php echo e(asset($intro_movie->intro_movie)); ?>"
                    <?php else: ?>
                    src="" <?php endif; ?>
                    type="video/mp4"/>
        </video>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <h3 class="h3heading" style="color:#222751 !important;">
                    <?php echo e(__('main.partners')); ?>

                </h3>
                <div class="col-12 row justify-content-around mt-5">
                    <div class="partSpan m-1 text-center">
                        <img class="img-fluid" width="67%" src="<?php echo e(asset('images/1.png')); ?>">
                    </div>
                    <div class="partSpan m-1 text-center">
                        <img class="img-fluid" width="80%" src="<?php echo e(asset('images/2.png')); ?>">
                    </div>
                    <div class="partSpan m-1 text-center">
                        <img class="img-fluid" width="70%" src="<?php echo e(asset('images/3.png')); ?>">
                    </div>
                    <div class="partSpan m-1 text-center">
                        <img class="img-fluid" width="60%" src="<?php echo e(asset('images/4.png')); ?>">
                    </div>
                    <div class="partSpan m-1 text-center">
                        <img class="img-fluid" width="80%" src="<?php echo e(asset('images/5.png')); ?>">
                    </div>
                    <div class="partSpan m-1 text-center">
                        <img class="img-fluid" width="80%" src="<?php echo e(asset('images/6.png')); ?>">
                    </div>

                    <div class="partSpan mt-3 text-center">
                        <img class="img-fluid" width="80%" src="<?php echo e(asset('images/7.png')); ?>">
                    </div>
                    <div class="partSpan mt-3 text-center">
                        <img class="img-fluid" width="70%" src="<?php echo e(asset('images/8.png')); ?>">
                    </div>
                    <div class="partSpan mt-3 text-center">
                        <img class="img-fluid" width="70%" src="<?php echo e(asset('images/9.png')); ?>">
                    </div>
                    <div class="partSpan mt-3 text-center">
                        <img class="img-fluid" width="70%" src="<?php echo e(asset('images/10.png')); ?>">
                    </div>
                    <div class="partSpan mt-3 text-center">
                        <img class="img-fluid" width="70%" src="<?php echo e(asset('images/11.png')); ?>">
                    </div>
                    <div class="partSpan mt-3 text-center">
                        <img class="img-fluid" width="70%" src="<?php echo e(asset('images/12.png')); ?>">
                    </div>
                    <div class="partSpan mt-3 text-center">
                        <img class="img-fluid" width="70%" src="<?php echo e(asset('images/13.png')); ?>">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row flex-column p-4" style="margin: 50px 0;">
        ...
        <!--first row-->
        <div class="row w-100 m-0 <?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> flex-row-reverse <?php endif; ?>">
            ...
            <div class="col-sm-5">
                <h2 class="sec3-heading" style="color: #222751;">
                    <?php echo e(__('main.ehymyz-araby1')); ?>

                    <br>
                    <?php echo e(__('main.ehymyz-araby2')); ?>

                </h2>
                <p class="sec3-p mt-4">
                    <?php echo e(__('main.ehymyz-araby3')); ?>
            ...
            <div class="col-sm-7 row mt-4 mt-sm-2 mt-md-0 px-0">
                ...
                <div class="col-sm-6 pr-0">
                    <div class="inner lightBox" style="min-height: 250px !important;">
                        <img src="<?php echo e(asset('images/package.svg')); ?>">
                        <h5><?php echo e(__('main.resp')); ?></h5>
                        <p><?php echo e(__('main.resp2')); ?></p>
                        <a><?php echo e(__('main.viewMore')); ?></a>
                    </div>
                </div>
                ...
                <div class="col-sm-6 pr-0">
                    <div class="inner darkBox" style="min-height: 250px !important;">
                        <img src="<?php echo e(asset('images/package.svg')); ?>">
                        <h5><?php echo e(__('main.ourprices')); ?></h5>
                        <p><?php echo e(__('main.ourprices2')); ?></p>
                        <a><?php echo e(__('main.viewMore')); ?></a>
                    </div>
                </div>
            </div>
        ...
        <div class="row w-100 m-0 mt-5 justify-content-center">
            <div class="col-sm-6 row px-md-3 p-sm-1">
                ...
                <div class="col-sm-6 pl-0">
                    <div class="inner darkBox">
                        <img src="<?php echo e(asset('images/package.svg')); ?>">
                        <h5><?php echo e(__('main.timesaver')); ?></h5>
                        <p><?php echo e(__('main.timesaver2')); ?></p>
                        <a><?php echo e(__('main.viewMore')); ?></a>
                    </div>
                </div>
                ...
                <div class="col-sm-6 pl-0">
                    <div class="inner lightBox">
                        <img src="<?php echo e(asset('images/package.svg')); ?>">
                        <h5><?php echo e(__('main.easy')); ?></h5>
                        <p><?php echo e(__('main.easy2')); ?></p>
                        <br>
                        <a><?php echo e(__('main.viewMore')); ?></a>
                    </div>
                </div>
            ...
            <div class="col-sm-6 row">
                <div class="col-sm-6 pl-0">
                    <div class="inner darkBox">
                        <img src="<?php echo e(asset('images/package.svg')); ?>">
                        <h5><?php echo e(__('main.dash')); ?></h5>
                        <p><?php echo e(__('main.dash2')); ?></p>
                        <br>
                        <a><?php echo e(__('main.viewMore')); ?></a>
                    </div>
                </div>
                <div class="col-sm-6 pl-0">
                    <div class="inner lightBox">
                        <img src="<?php echo e(asset('images/package.svg')); ?>">
                        <h5><?php echo e(__('main.integ')); ?></h5>
                        <p><?php echo e(__('main.integ2')); ?></p>
                        <a><?php echo e(__('main.viewMore')); ?></a>
                    </div>
                </div>
            </div>
    ...
    <!--====SECTION4====-->
    <div class="row <?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> flex-row-reverse <?php endif; ?> section4EveryThing p-5"
         style="margin-top: 150px;">
        <div class="col-sm-6 banner-content pr-4">
            <h2 class="sec3-heading">
                <?php echo e(__('main.allneeded')); ?>

                <br>
                <?php echo e(__('main.allneeded2')); ?>

            </h2>
            <p class="sec3-p mt-4"><?php echo e(__('main.allneeded3')); ?></p>
            <a class="loginBtn"
               style="<?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> float: left; <?php else: ?> float: right; <?php endif; ?> margin-top:20px;color: white; background: #222751; border: 1px solid #222751; border-radius: 3px; padding: 11px 39px !important;"
               href="http://arabygithub.test/ar/client/login">
                <?php echo e(__('main.joinNow')); ?>
        ...
        <div class="col-sm-6">
            <div class="img-viewer-app text-center mt-5">
                ...
                <img class="img-fluid" style="width: 80%" src="<?php echo e(asset('images/sec4.png')); ?>">
            </div>
    ...
    <div class="row" style="background: #222751;padding-top: 70px;">
        ...
        <div class="col-sm-6">
            <div class="img-viewer-app text-center">
                <img class="img-fluid" style="max-width: 69%;" src="<?php echo e(asset('images/papper.png')); ?>">
            </div>
        </div>

        <div
            class="col-sm-6 banner-content <?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> pl-5 <?php else: ?> pr-4 <?php endif; ?> mt-5"
            style="padding-bottom:90px;">
            <h2 class="sec3-heading" style="color: white;font-size: 25px !important;"><?php echo e(__('main.among')); ?></h2>

            <ul class="<?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> text-left <?php else: ?> text-right <?php endif; ?>">
                <li class="mt-3">
                    <svg class="<?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> float-left mr-1 <?php endif; ?>"
                    ...
                    <span class="spanLiSec5"><?php echo e(__('main.among2')); ?></span>
                </li>
                <li class="mt-3">
                    <svg class="<?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> float-left mr-1 <?php endif; ?>"
                         xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                    ...
                    <span class="spanLiSec5"><?php echo e(__('main.among3')); ?></span>
                </li>
                ...
                <li class="mt-3">
                    ...
                    <span class="spanLiSec5"><?php echo e(__('main.among4')); ?></span>
                </li>
            </ul>
            <svg style="position:absolute;right: 0" xmlns="http://www.w3.org/2000/svg" width="113" height="120"
                 viewBox="0 0 113 120" fill="none">
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="img-viewer-app text-center">
                <img class="img-fluid" style="margin-top: -50px;width: 85%;" src="<?php echo e(asset('images/pc2.png')); ?>">
            </div>
        </div>

        <div
            class="col-sm-7 banner-content <?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> pl-5 <?php else: ?> pr-4 <?php endif; ?> mt-5">
            <h2 class="sec3-heading pt-5" style="color: #222751;">
                <?php echo e(__('main.develop')); ?>

                <br>
                <?php echo e(__('main.develop2')); ?>
            ...
            <ul class="<?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> text-left <?php else: ?> text-right <?php endif; ?>">
                <li class="mt-3">
                    ...
                    <span class="spanLiSec6" style="width: 91%;display: block;"><?php echo e(__('main.develop3')); ?></span>
                </li>
                <li class="mt-2">
                    <svg class="<?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> float-left mr-1 <?php endif; ?>"
                         xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                    ...
                    <span class="spanLiSec6"><?php echo e(__('main.develop4')); ?></span>
                </li>
                <li class="mt-2">
                    <svg class="<?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> float-left mr-1 <?php endif; ?>"
                         xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                    ...
                    <span class="spanLiSec6" style="width: 91%;display: block;"><?php echo e(__('main.develop5')); ?></span>
                </li>
            </ul>
    ...
    <div class="row <?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> flex-row-reverse <?php endif; ?>"
        ...
        <div
            class="col-sm-6 banner-content <?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> pl-5 <?php else: ?> pr-5 <?php endif; ?>">
            <h2 class="sec3-heading"
                style="color: #222751;font-weight:600;font-size: 25px !important;line-height: 38px;">
                <?php echo e(__('main.amaraby')); ?>

                <br>
                <?php echo e(__('main.amaraby2')); ?>

            </h2>
            <p class="sec3-p mt-4" style="font-size: 20px;line-height:32px; "><?php echo e(__('main.amaraby3')); ?></p>

            <div class="d-flex <?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> justify-content-end <?php endif; ?> mt-2">
                <img src="<?php echo e(asset('images/appstore.png')); ?>" width="180">
                <img src="<?php echo e(asset('images/gplay.png')); ?>" width="180">
            </div>
        </div>
        ...
        <div class="col-sm-6 d-sm-block d-none">
            <div class="img-viewer-app text-center">
                <img class="img-fluid" style="max-width: 30%; position: absolute; bottom: -160px; right: 45px;"
                     src="<?php echo e(asset('images/phone2.png')); ?>">
                <img class="img-fluid" style="max-width: 30%; position: absolute; top: -50px; "
                     src="<?php echo e(asset('images/phone1.png')); ?>">
            </div>
        </div>
    ...
    <div class="sec8 mt-3 mb-5">
        <!--<h3 class="sec3-heading pt-5 text-center" style="color:#222751 !important;"><?php echo e(__('main.ready')); ?></h3>-->
        <!--<p class="text-center mt-1" style="color:#637381;font-size: 23px;"><?php echo e(__('main.ready2')); ?></p>-->
        <!--<div class="row p-2 m-0 justify-content-around mt-5">-->

        <!--    <div class="col-sm-4 p-3">-->
        <!--        <div class="innerSec8">-->
        <!--            <div class="sec8Title text-center p-2">-->
        <!--                <h4 style="color:#222751;font-size: 25px;font-weight: 500 !important;"><?php echo e(__('main.asasi')); ?></h4>-->
        <!--            </div>-->
        <!--            <ul class="<?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> text-left <?php else: ?> text-right <?php endif; ?>">-->
        <!--                <li class="mt-3">-->
        <!--                    <span class="spanLiSec6 h4">-->
        <!--                        <?php echo e(__('main.asasi2')); ?>-->
        <!--                    </span>-->
        <!--                </li>-->
        <!--                <li>-->
        <!--                    <svg class="<?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> float-left mr-1 <?php endif; ?>"-->
        ...
        <!--                            stroke="#DF8317" stroke-width="2" stroke-linecap="round"/>-->
        <!--                    </svg>-->
        <!--                    <span class="spanLiSec6"><?php echo e(__('main.asasi3')); ?> </span>-->
        <!--                </li>-->
        <!--                <li>-->
        <!--                    <svg class="<?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> float-left mr-1 <?php endif; ?>"-->
        <!--                         xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25"-->
        ...
        <!--                            stroke="#DF8317" stroke-width="2" stroke-linecap="round"/>-->
        <!--                    </svg>-->
        <!--                    <span class="spanLiSec6"><?php echo e(__('main.asasi4')); ?></span>-->
        <!--                </li>-->
        ...
        <!--                            stroke="#DF8317" stroke-width="2" stroke-linecap="round"/>-->
        <!--                    </svg>-->
        <!--                    <span class="spanLiSec6"><?php echo e(__('main.asasi5')); ?></span>-->
        ...
        <!--                            stroke="#DF8317" stroke-width="2" stroke-linecap="round"/>-->
        <!--                    </svg>-->
        <!--                    <span class="spanLiSec6"><?php echo e(__('main.asasi6')); ?></span>-->
        ...
        <!--                            stroke="#DF8317" stroke-width="2" stroke-linecap="round"/>-->
        <!--                    </svg>-->
        <!--                    <span class="spanLiSec6"><?php echo e(__('main.asasi7')); ?></span>-->

        <!--                </li>-->
        <!--                <li>-->
        <!--                    <a class="subscriptNow"><?php echo e(__('main.asasi8')); ?></a>-->
        <!--                </li>-->
        <!--            </ul>-->
        <!--        </div>-->
        <!--    </div>-->
        ...
        <!--            <div class="sec8Title text-center p-2">-->
        <!--                <h4 style="color:white;font-size: 25px;font-weight: 500 !important;"><?php echo e(__('main.advanced1')); ?></h4>-->
        <!--            </div>-->
        <!--            <ul class="<?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> text-left <?php else: ?> text-right <?php endif; ?>">-->
        <!--                <li class="mt-3">-->
        <!--                    <span class="spanLiSec6 h4"-->
        <!--                          style="color:rgba(255,255,255,0.75);"><?php echo e(__('main.advanced2')); ?></span>-->
        <!--                </li>-->
        <!--                <li>-->
        <!--                    <svg class="<?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> float-left mr-1 <?php endif; ?>"-->
        <!--                         xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25"-->
        ...
        <!--                          style="color:rgba(255,255,255,0.75);width: 91%;display: block"><?php echo e(__('main.advanced3')); ?></span>-->
        <!--                </li>-->
        <!--                <li>-->
        <!--                    <svg class="<?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> float-left mr-1 <?php endif; ?>"-->
        <!--                         xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25"-->
        ...
        <!--                    </svg>-->
        <!--                    <span class="spanLiSec6"-->
        <!--                          style="color:rgba(255,255,255,0.75);"><?php echo e(__('main.asasi4')); ?></span>-->
        <!--                </li>-->
        ...
        <!--                            stroke="#DF8317" stroke-width="2" stroke-linecap="round"/>-->
        <!--                    </svg>-->
        <!--                    <span class="spanLiSec6" style="color:rgba(255,255,255,0.75);"><?php echo e(__('main.asasi5')); ?></span>-->
        ...
        <!--                            stroke="#DF8317" stroke-width="2" stroke-linecap="round"/>-->
        <!--                    </svg>-->
        <!--                    <span class="spanLiSec6" style="color:rgba(255,255,255,0.75);"><?php echo e(__('main.asasi6')); ?></span>-->
        ...
        <!--                            stroke="#DF8317" stroke-width="2" stroke-linecap="round"/>-->
        <!--                    </svg>-->
        <!--                    <span class="spanLiSec6" style="color:rgba(255,255,255,0.75);"><?php echo e(__('main.asasi7')); ?></span>-->
        <!--                </li>-->
        <!--                <li>-->
        <!--                    <a class="subscriptNow2"><?php echo e(__('main.asasi8')); ?></a>-->
        <!--                </li>-->
        <!--            </ul>-->
        <!--        </div>-->
        <!--    </div>-->
        ...
        <!--        <div class="innerSec8">-->
        <!--            <div class="sec8Title text-center p-2">-->
        <!--                <h4 style="color:#222751;font-size: 25px;font-weight: 500 !important;"><?php echo e(__('main.inclusive1')); ?></h4>-->
        <!--            </div>-->
        <!--            <ul class="<?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> text-left <?php else: ?> text-right <?php endif; ?>">-->
        <!--                <li class="mt-3">-->
        <!--                    <span class="spanLiSec6 h4"><?php echo e(__('main.inclusive2')); ?></span>-->
        <!--                </li>-->
        <!--                <li>-->
        <!--                    <svg class="<?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> float-left mr-1 <?php endif; ?>"-->
        <!--                         xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25"-->
        ...
        <!--                            stroke="#DF8317" stroke-width="2" stroke-linecap="round"/>-->
        <!--                    </svg>-->
        <!--                    <span class="spanLiSec6" style="width: 91%;display: block"><?php echo e(__('main.inclusive3')); ?></span>-->
        <!--                </li>-->
        <!--                <li>-->
        <!--                    <svg class="<?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> float-left mr-1 <?php endif; ?>"-->
        <!--                         xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25"-->
    ...
    <div class="sec8 col-sm-8 col-11 mx-auto mt-5 mb-3">
        ...
        <h3 class="sec3-heading pt-5 text-center mb-3"
            ...
            <?php echo e(__('main.discount1')); ?>

        </h3>
        <p class="text-center mt-1" style="color:#637381;font-size: 22px;">
            <?php echo e(__('main.discount2')); ?>

            <br>
            <?php echo e(__('main.discount3')); ?>

        </p>
        <div class="row col-sm-10 mx-auto mt-5" style="flex-wrap: nowrap;">
            <input type="text" placeholder="<?php echo e(__('main.email')); ?>" name="email" class="form-control"
                   style="background: rgba(208, 209, 216, 0.30); backdrop-filter: blur(5px); height: 65px; border-radius: 0; width: 179%;">
            <button style="background: #222751; height: 65px; border-radius: 0;"><?php echo e(__('main.send')); ?></button>
        </div>
        <svg
            style="right: -50px; position: relative;<?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> float:right; <?php endif; ?>"
    ...
    <div class="sec8 col-sm-9 col-11 mb-1 mx-auto ">
        ...
        <div class="row mx-auto mt-5" style="flex-wrap: nowrap;">
            ...
            <div class="col-8 text-right">
                ...
                <p style="color: #1B1C31; text-align: right; font-family: Cairo; font-size: 25px; font-style: normal; font-weight: 400; line-height: 41px; /* 136.667% */ letter-spacing: -0.6px;"><?php echo e(__('main.people1')); ?></p>
                <br>
                <br>
                <div class="userDet">
                    <p style="color: #111C55; font-family: Cairo; font-size: 20px; font-style: normal; font-weight: 700; line-height: 30px; /* 150% */ letter-spacing: -0.6px;"><?php echo e(__('main.people2')); ?></p>
                    <p style="color: #757095; font-family: Poppins; font-size: 16px; font-style: normal; font-weight: 500; line-height: 24px; /* 150% */ letter-spacing: -0.32px;"><?php echo e(__('main.people3')); ?></p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('site.layouts.app-main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/elaraby_erp_new/resources/views/site/index.blade.php ENDPATH**/ ?>