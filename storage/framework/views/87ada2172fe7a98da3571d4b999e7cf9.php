...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(isset($companies)): ?>
        ...
        <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(!$company->clients->isEmpty()): ?>
                <?php
    ...
    <div class="row tile_count text-center">
        <div class="col-md-4 col-sm-12 col-xs-12">
            <div class="tile_stats_count">
                ...
                <div class="count">
                    <?php echo e(floatval($total_deserved)); ?>
        ...
        <div class="col-md-4 col-sm-12 col-xs-12">
            <div class="tile_stats_count">
                ...
                <div class="count">
                    <?php echo e(floatval($total_paid)); ?>
        ...
        <div class="col-md-4 col-sm-12 col-xs-12">
            <div class="tile_stats_count">
                ...
                <div class="count">
                    <?php echo e(floatval($total_rest)); ?>
    ...
    <div class="row mt-2 mb-2">
        <div class="col-lg-4 pull-right">
            <div class="bg-danger text-white p-2" style="font-size: 14px;">
                الشركات قيد التجربة :
                ( <?php echo e($trial_subscriptions->count()); ?> )
            </div>
        </div>
        ...
        <div class="col-lg-4 pull-right">
            <div class="bg-danger text-white p-2" style="font-size: 14px;">
                ...
                ( <?php echo e($about_end_subscriptions->count()); ?> )
            </div>
        </div>
        ...
        <div class="col-lg-4 pull-right">
            <div class="bg-danger text-white p-2" style="font-size: 14px;">
                ...
                ( <?php echo e($active_subscriptions->count()); ?> )
            </div>
        </div>
    </div>
    <div class="clearfix"></div>
...
<?php echo $__env->make('admin.layouts.app-main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/elaraby_erp_new/resources/views/admin/home.blade.php ENDPATH**/ ?>