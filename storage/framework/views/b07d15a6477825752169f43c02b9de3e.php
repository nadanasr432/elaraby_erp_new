                            ...
                            <li class="dropdown-menu-footer">
                                ...
                                <a class="dropdown-item d-flex align-items-center"
                                    ...
                                    <span class="badge badge-success"
                                        style="font-size: 10px; padding: 2px 5px; border-radius: 50%;"><?php echo e(__('sidebar.new')); ?></span>
                                    <!-- Badge for "New" -->
                                </a>
...
<?php /**PATH /var/www/html/elaraby_erp_new/resources/views/client/layouts/common/header1.blade.php ENDPATH**/ ?>