...
<nav
    ...
    <div class="navbar-wrapper navbar-dark" style="background: #222751;">
            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item mx-auto text-center d-sm-none d-block"
                    ...
                    <a class="navbar-brand text-center"
                        ...
                        <?php echo e(Auth::user()->company->company_name); ?>

                    </a>
                </li>
                <li class="nav-item mx-auto text-center" style="margin-top: -10px!important;position: relative">
                    <a class="navbar-brand text-center" href="<?php echo e(route('client.home')); ?>">
                ...
                <ul class="col-12 nav navbar-nav float-right"
                    ...
                    <li class="nav-item d-none d-md-block float-right"
                        ...
                        <a class="nav-link modern-nav-toggle pr-0" data-toggle="collapse">
                            <img src="<?php echo e(asset('assets/svgs/mini.svg')); ?>" width="30">
                        </a>
                    </li>
                    <!---------------------SIDEBAR TOGGLER------------------------------------------------->
                    ...
                    <li class="nav-item d-none d-md-block float-right"
                        ...
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown" aria-expanded="false">
                            <img src="<?php echo e(asset('assets/svgs/msgs.svg')); ?>" width="25">
                            <span class="badge badge-pill badge-default badge-warning badge-default badge-up"
                                id="taskcount">
                                0
                            </span>
                        </a>
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h4 class="dropdown-header m-0">
                                    <span class="grey darken-2"><?php echo app('translator')->get('home.Messages'); ?> </span>
                            ...
                            <li class="dropdown-menu-footer">
                                <a class="dropdown-item text-muted text-center" href="#">
                                    <?php echo app('translator')->get('home.There are no current messages!'); ?>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item d-none d-md-block float-right"
                        ...
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown" aria-expanded="false">
                            <img src="<?php echo e(asset('assets/svgs/notifi.svg')); ?>" width="25">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h4 class="dropdown-header m-0">
                                    <span class="grey darken-2"><?php echo app('translator')->get('home.Notifications'); ?> </span>
                                    <span class="notification-tag badge badge-default badge-danger float-right m-0">
                                        <?php echo app('translator')->get('home.New'); ?>
                                    </span>
                                </h4>
                            ...
                            <li class="dropdown-menu-footer">
                                <a class="dropdown-item text-muted text-center" href="#">
                                    <?php echo app('translator')->get('home.No notifications yet!'); ?>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item d-none d-md-block float-right"
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h4 class="dropdown-header m-0">
                                    <span class="grey darken-2" style="font-size: 16px !important;"><?php echo app('translator')->get('home.Quick shortcuts'); ?>
                                    </span>
                                    <span class="notification-tag badge badge-default badge-danger float-right m-0">
                                        <?php echo app('translator')->get('home.New'); ?>
                                    </span>
                            ...
                            <li class="dropdown-menu-footer">
                                ...
                                <a class="dropdown-item" href="<?php echo e(route('client.quotations.create')); ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                        <path
                                            d="M160 256C160 202.1 202.1 160 256 160C309 160 352 202.1 352 256C352 309 309 352 256 352C202.1 352 160 309 160 256zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z">
                                        </path>
                                    </svg>
                                    <?php echo app('translator')->get('sidebar.addNewQuotation'); ?>
                                </a>
                                ...
                                <a class="dropdown-item" href="<?php echo e(route('client.products.createservice')); ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                        <path
                                            d="M160 256C160 202.1 202.1 160 256 160C309 160 352 202.1 352 256C352 309 309 352 256 352C202.1 352 160 309 160 256zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z">
                                        </path>
                                    </svg>
                                    <?php echo app('translator')->get('products.addnewproductseveces'); ?>
                                </a>
                                ...
                                <a class="dropdown-item" href="<?php echo e(route('client.sale_bills.create1')); ?>">
                                    ...
                                    <?php echo e(__('sidebar.Add a new sales invoice')); ?>

                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('client.sale_bills.create1')); ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="width: 16px; margin-right: 5px;">
                                        <path
                                            d="M160 256C160 202.1 202.1 160 256 160C309 160 352 202.1 352 256C352 309 309 352 256 352C202.1 352 160 309 160 256zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z">
                                        </path>
                                    </svg>
                                    <span class="mr-1"><?php echo e(__('sidebar.New sales')); ?></span>
                                    <span class="badge badge-success" style="font-size: 10px; padding: 2px 5px; border-radius: 50%;"><?php echo e(__('sidebar.new')); ?></span> <!-- Badge for "New" -->
                                </a>


                                <a class="dropdown-item" href="<?php echo e(route('client.buy_bills.create')); ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                        <path
                                            d="M160 256C160 202.1 202.1 160 256 160C309 160 352 202.1 352 256C352 309 309 352 256 352C202.1 352 160 309 160 256zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z">
                                        </path>
                    ...
                    <li class="nav-item d-md-block float-right posLi"
                        ...
                        <a class="posNavigator" href="<?php echo e(route('client.pos.create')); ?>">
                            <span class="mr-1">
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <p style="color:black;font-size: 13px !important;margin-top: 10px;margin-left: 15px">
                            <img src="<?php echo e(asset('assets/svgs/weather.svg')); ?>" width="25" />
                            <span style="color: #222751; font-size: 20px; font-family: Cairo; font-weight: 400;">
                                <?php echo e(date('H:i:s', strtotime(date('H:i:s')) + 60 * 60)); ?>
                        ...
                        <?php elseif(Config::get('app.locale') == 'ar'): ?>
                            <a rel="alternate" hreflang="en"
                                ...
                                <img style="border-radius: 50%;border: 1px dashed #222751;"
                                    src="<?php echo e(asset('assets/svgs/en.svg')); ?>" width="25">
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link p-1" data-toggle="dropdown">
                            ...
                            <span style="color:gray"><?php echo e(Auth::user()->name); ?></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right p-0" style="width: 150px !important;">
                            ...
                            <a class="dropdown-item" href="<?php echo e(url('client/go-to-upgrade')); ?>">
                                <i class="fa fa-user"></i> <?php echo e(__('main.pricing')); ?>

                            </a>

                            <a class="dropdown-item" href="<?php echo e(route('client.profile.edit', Auth::user()->id)); ?>">
                                <i class="fa fa-user"></i> <?php echo e(__('main.edit-profile')); ?>
...
<?php /**PATH /var/www/html/elaraby_erp_new/resources/views/client/layouts/common/header.blade.php ENDPATH**/ ?>