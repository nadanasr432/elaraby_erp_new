                ...
                <div class="card-header border-bottom border-secondary p-1">
                    ...
                    <div class="d-flex justify-content-between align-items-baseline">
                        <h3 class="pull-right font-weight-bold">
                            ...
                            <span class="badge badge-success"><?php echo e(count($sale_bills)); ?></span>
                        </h3>
                ...
                <div class="card-body p-1">
                    <div id="example-table_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer p-0">
                        <div class="d-flex justify-content-between align-items-top">
                            <div class="col-sm-4">
                                <form method="GET" action="<?php echo e(route('client.sale_bills.index1')); ?>" id="dateFilterForm"
                                    class="d-flex align-items-end  gap-3">
                                    <div class="d-flex flex-column align-items-start">
                                        <label for="fromDate" class="form-label mb-1"><?php echo e(__('main.from')); ?></label>
                                        <input type="date" name="from" class="form-control" placeholder="From Date"
                                            value="<?php echo e(request('from')); ?>" id="fromDate">
                                    </div>
                                    <div class="d-flex flex-column align-items-start ml-2 mr-2">
                                        <label for="toDate" class="form-label mb-1"><?php echo e(__('main.to')); ?></label>
                                        <input type="date" name="to" class="form-control" placeholder="To Date"
                                            value="<?php echo e(request('to')); ?>" id="toDate">
                                    </div>
                                ...
                                <div class="dt-buttons btn-group d-flex  align-items-end ">
                                    <button class="btn btn-primary pull-left p-1 mainBtnNewDes buttons-excel buttons-html5"
                                        ...
                                        <a href="<?php echo e(route('sale_bills.export.excel', [
                        ...
                        <div class="row p-0">
                            <div class="col-sm-12 p-0">
                                <table style="border-radius: 5px !important; overflow-x: hidden;"
                                    class="defaultTableMain table dataTable no-footer" id="sale_bills_table" role="grid">
                                    <thead class="text-center">
                                        <tr role="row">
                                            <th style="border-radius: 0 10px 0 0"><?php echo e(__('sidebar.invoice number')); ?></th>
                                            <th><?php echo e(__('sidebar.customer name')); ?></th>
                                            <th><?php echo e(__('sidebar.Invoice date')); ?></th>
                                            <th><?php echo e(__('sidebar.Billing time')); ?></th>
                                            <th><?php echo e(__('products.store')); ?></th>
                                            <th><?php echo e(__('sidebar.Final total')); ?></th>
                                            <th><?php echo e(__('sidebar.Number of items')); ?></th>
                                            <th><?php echo e(__('sidebar.Status')); ?></th>
                                            <th style="border-radius: 10px 0 0 0;width: 10% !important;">
                                                <?php echo e(__('sidebar.Show')); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        $totalTax = 0;
                                        ?>
                                        <?php $__currentLoopData = $sale_bills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $sale_bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="<?php echo e($index % 2 == 0 ? 'even' : 'odd'); ?>" role="row">
                                                <td><?php echo e($sale_bills_count - $index); ?></td>
                                                
                                                <td>
                                                    <?php if(empty($sale_bill->outer_client_id)): ?>
                                                        <?php echo e(__('sidebar.Cash sales client')); ?>

                                                    <?php else: ?>
                                                        <?php if(!empty($sale_bill->OuterClient)): ?>
                                                            <?php echo e($sale_bill->OuterClient->client_name); ?>

                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                </td>
                                                <td><?php echo e($sale_bill->date); ?></td>
                                                <td><?php echo e($sale_bill->time); ?></td>
                                                <td><?php echo e($sale_bill->store?->store_name ?? ' '); ?></td>
                                                <td>
                                                    <?php
                                                        $total += $sale_bill->final_total;
                                                        $totalTax += $sale_bill->total_tax;
                                                    ?>
                                                    <?php echo e($sale_bill->final_total); ?> <img src="<?php echo e(asset('images/Sr_coin.svg')); ?>" width="15px">
                                                </td>
                                                <td><?php echo e($sale_bill->elements->count()); ?></td>
                                                <td>
                                                    <input type="checkbox" class="toggle-status"
                                                        data-id="<?php echo e($sale_bill->id); ?>"
                                                        <?php echo e($sale_bill->deleted_at ? '' : 'checked'); ?>>
                                                </td>
                                                <td style="padding: 5px !important;">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu p-0" aria-labelledby="dropdownMenuButton"
                                                            ...
                                                            <!--SHOW--->
                                                            <a href="<?php echo e(route('sale-bill-show1', $sale_bill->id)); ?>"
                                                                ...
                                                                <?php echo e(__('sidebar.show')); ?>

                                                            </a>

                                                            <!--EDIT--->
                                                            <a href="<?php echo e(route('client.sale_bills.edit1', [$sale_bill->token, $sale_bill->company_id])); ?>"
                                                                class="dropdown-item"
                                                                style="font-size: 12px  !important; padding: 9px 11px;border-bottom: 1px solid #2d2d2d2d">
                                                                ...
                                                                <?php echo e(__('sidebar.edit or return')); ?>

                                                            </a>
                                                            <a href="<?php echo e(route('client.sale_bills.print', [$sale_bill->token, 9, 3, 0])); ?>"
                                                                class="dropdown-item"
                                                                ...
                                                                <?php echo e(__('sidebar.Goods Receipt Order')); ?>

                                                            </a>
                                                            <form
                                                                action="<?php echo e(route('client.sale_bills.deleteBill', ['billid' => $sale_bill->id])); ?>"
                                                            ...
                                                            <script>
                                                                function confirmDelete() {
                                                                    return confirm("<?php echo app('translator')->get('main.delete_confirm'); ?>");
                                                                }
                                                            </script>
                                                        </div>
                                                    </div>
                    ...
                    <div class="d-flex justify-content-between mt-1 mb-1">
                        <div>
                            <span class="badge badge-success p-1 font-weight-bold">
                                <?php echo e(__('sidebar.Total billing prices')); ?>

                                ( <?php echo e(floatval($total)); ?> ) <img src="<?php echo e(asset('images/Sr_coin.svg')); ?>" width="15px">
                            </span>
                        </div>
                        <div>
                            <span class="badge badge-success p-1 font-weight-bold">
                                <?php echo e(__('sidebar.Total billing taxes')); ?>

                                ( <?php echo e(floatval($totalTax)); ?> ) <img src="<?php echo e(asset('images/Sr_coin.svg')); ?>" width="15px">
                            </span>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.remove_element').on('click', function() {
            ...
            $.post('<?php echo e(url('/client/sale-bills/element/delete')); ?>', {
                    '_token': '<?php echo e(csrf_token()); ?>',
                    element_id: element_id
                },
                function(data) {
                    $.post('<?php echo e(url('/client/sale-bills/updateData')); ?>', {
                            '_token': '<?php echo e(csrf_token()); ?>',
    ...
    $(document).ready(function() {
        $('.toggle-status').on('change', function() {
            var saleBillId = $(this).data('id');
            var status = $(this).is(':checked') ? 'active' : 'inactive';
            var message = status === 'active' ? 'Are you sure you want to activate this sale bill?' :
                'Are you sure you want to deactivate this sale bill?';
            var confirmation = confirm(message);

            if (confirmation) {
                $.ajax({
                    url: '<?php echo e(route('client.sale_bills.toggle_status')); ?>',
                    method: 'POST',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
...
<?php echo $__env->make('client.layouts.app-main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/elaraby_erp_new/resources/views/client/sale_bills1/index.blade.php ENDPATH**/ ?>