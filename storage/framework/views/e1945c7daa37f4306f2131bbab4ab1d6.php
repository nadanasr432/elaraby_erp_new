    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="nav-item <?php echo e(Request::is('*home') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('admin.home')); ?>"><i class="sidebar-item-icon fa fa-dashboard"></i>
            ...
            <li class="nav-item <?php echo e(Request::is('*/companies*') ? 'active open' : ''); ?>">
            ...
            <li class="nav-item <?php echo e(Request::is('*/packages*') ? 'active open' : ''); ?>">
                ...
                <ul class="menu-content">
                    <li class="<?php echo e(Request::is('*/packages/create') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('admin.packages.create')); ?>">
                            <i class="fa fa-plus"></i>
                            اضافة باقة جديدة
                        </a>
                    </li>
                    <li class="<?php echo e(Request::is('*/packages') ? 'active' : ''); ?>">
            ...
            <li class="nav-item <?php echo e(Request::is('*/types*') ? 'active open' : ''); ?>">
                ...
                <ul class="menu-content">
                    <li class="<?php echo e(Request::is('*/types/create') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('admin.types.create')); ?>">
                            <i class="fa fa-plus"></i>
                            اضافة نوع اشتراك جديد
                        </a>
                    </li>
                    <li class="<?php echo e(Request::is('*/types') ? 'active' : ''); ?>">
            ...
            <li class="nav-item <?php echo e(Request::is('*/subscriptions*') ? 'active open' : ''); ?>">
                <a href="javascript:;"><i class="sidebar-item-icon fa fa-ticket"></i>
                    <span class="menu-title">
                     الاشتراكات
                    </span>
                ...
                <ul class="menu-content">
                    ...
                    <li class="<?php echo e(Request::is('*/subscriptions-filter-get') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('subscriptions.filter.get')); ?>">
                            <i class="fa fa-plus"></i>
            ...
            <li class="nav-item <?php echo e(Request::is('*/payments*') ? 'active open' : ''); ?>">
                ...
                <ul class="menu-content">
                    <li class="<?php echo e(Request::is('*/payments/create*') ? 'active' : ''); ?>">
                    ...
                    <li class="<?php echo e(Request::is('*/payments-report-get') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('payments.report.get')); ?>">
                            <i class="fa fa-plus"></i>
            ...
            <li class="nav-item <?php echo e(Request::is('*/contacts*') ? 'active open' : ''); ?>">
            ...
            <li class="nav-item <?php echo e(Request::is('*/social-links*') ? 'active open' : ''); ?>">
                <a href="<?php echo e(route('social.links')); ?>"><i class="sidebar-item-icon fa fa-info-circle"></i>
                    <span class="menu-title">
            ...
            <li class="nav-item <?php echo e(Request::is('*/intro*') ? 'active open' : ''); ?>">
                <a href="<?php echo e(route('intro')); ?>"><i class="sidebar-item-icon fa fa-file-movie-o"></i>
                    <span class="menu-title">
                     فيديو شرح المقدمة
                    </span>
                </a>
...
<?php /**PATH /var/www/html/elaraby_erp_new/resources/views/admin/layouts/common/ul_sidebar.blade.php ENDPATH**/ ?>